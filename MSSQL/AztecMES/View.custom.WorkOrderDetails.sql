...
/*
Create view fxAztec.custom.WorkOrderDetails
*/

use fxAztec
go

--drop table custom.WorkOrderDetails
if	objectproperty(object_id('custom.WorkOrderDetails'), 'IsView') = 1 begin
	drop view custom.WorkOrderDetails
end
go
