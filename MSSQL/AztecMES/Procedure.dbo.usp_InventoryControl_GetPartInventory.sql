...
/*
Create procedure fxAztec.dbo.usp_InventoryControl_GetPartInventory
*/

--use fxAztec
--go

if	objectproperty(object_id('dbo.usp_InventoryControl_GetPartInventory'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_InventoryControl_GetPartInventory
end
go
