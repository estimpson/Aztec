...
/*
Create Table.Fx.EDIToyota.ManifestDetails.sql
*/

--use Fx
--go

--drop table EDIToyota.ManifestDetails
if	objectproperty(object_id('EDIToyota.ManifestDetails'), 'IsTable') is null begin
...
/*
Create trigger EDIToyota.tr_ManifestDetails_uRowModified on EDIToyota.ManifestDetails
*/

--use Fx
--go

if	objectproperty(object_id('EDIToyota.tr_ManifestDetails_uRowModified'), 'IsTrigger') = 1 begin
	drop trigger EDIToyota.tr_ManifestDetails_uRowModified
end
go
