...
/*
Create Table.Fx.EDIToyota.ShipSchedules.sql
*/

--use Fx
--go

--drop table EDIToyota.ShipSchedules
if	objectproperty(object_id('EDIToyota.ShipSchedules'), 'IsTable') is null begin
...
/*
Create trigger EDIToyota.tr_ShipSchedules_uRowModified on EDIToyota.ShipSchedules
*/

--use Fx
--go

if	objectproperty(object_id('EDIToyota.tr_ShipSchedules_uRowModified'), 'IsTrigger') = 1 begin
	drop trigger EDIToyota.tr_ShipSchedules_uRowModified
end
go
