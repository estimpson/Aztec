...
/*
Create Table.Fx.EDIToyota.PlanningAccums.sql
*/

--use Fx
--go

--drop table EDIToyota.PlanningAccums
if	objectproperty(object_id('EDIToyota.PlanningAccums'), 'IsTable') is null begin
...
/*
Create trigger EDIToyota.tr_PlanningAccums_uRowModified on EDIToyota.PlanningAccums
*/

--use Fx
--go

if	objectproperty(object_id('EDIToyota.tr_PlanningAccums_uRowModified'), 'IsTrigger') = 1 begin
	drop trigger EDIToyota.tr_PlanningAccums_uRowModified
end
go

create trigger EDIToyota.tr_PlanningAccums_uRowModified on EDIToyota.PlanningAccums after update
as
declare
	@TranDT datetime
,	@Result int
