...
/*
Create Table.Fx.EDIToyota.PlanningAuthAccums.sql
*/

--use Fx
--go

--drop table EDIToyota.PlanningAuthAccums
if	objectproperty(object_id('EDIToyota.PlanningAuthAccums'), 'IsTable') is null begin
...
/*
Create trigger EDIToyota.tr_PlanningAuthAccums_uRowModified on EDIToyota.PlanningAuthAccums
*/

--use Fx
--go

if	objectproperty(object_id('EDIToyota.tr_PlanningAuthAccums_uRowModified'), 'IsTrigger') = 1 begin
	drop trigger EDIToyota.tr_PlanningAuthAccums_uRowModified
end
go

create trigger EDIToyota.tr_PlanningAuthAccums_uRowModified on EDIToyota.PlanningAuthAccums after update
as
declare
	@TranDT datetime
,	@Result int
