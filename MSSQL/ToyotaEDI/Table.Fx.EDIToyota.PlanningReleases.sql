...
/*
Create Table.Fx.EDIToyota.PlanningReleases.sql
*/

--use Fx
--go

--drop table EDIToyota.PlanningReleases
if	objectproperty(object_id('EDIToyota.PlanningReleases'), 'IsTable') is null begin
...
/*
Create trigger EDIToyota.tr_PlanningReleases_uRowModified on EDIToyota.PlanningReleases
*/

--use Fx
--go

if	objectproperty(object_id('EDIToyota.tr_PlanningReleases_uRowModified'), 'IsTrigger') = 1 begin
	drop trigger EDIToyota.tr_PlanningReleases_uRowModified
end
go
