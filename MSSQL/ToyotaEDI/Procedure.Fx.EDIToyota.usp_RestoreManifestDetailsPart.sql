...
/*
Create Procedure.Fx.EDIToyota.usp_RestoreManifestDetailsPart.sql
*/

--use Fx
--go

if	objectproperty(object_id('EDIToyota.usp_RestoreManifestDetailsPart'), 'IsProcedure') = 1 begin
	drop procedure EDIToyota.usp_RestoreManifestDetailsPart
end
go
