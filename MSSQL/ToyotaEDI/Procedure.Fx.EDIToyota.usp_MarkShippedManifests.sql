...
/*
Create Procedure.Fx.EDIToyota.usp_MarkShippedManifests.sql
*/

--use Fx
--go

if	objectproperty(object_id('EDIToyota.usp_MarkShippedManifests'), 'IsProcedure') = 1 begin
	drop procedure EDIToyota.usp_MarkShippedManifests
end
go
