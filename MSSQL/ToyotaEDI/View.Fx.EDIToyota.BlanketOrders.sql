/*
Create View.Fx.EDIToyota.BlanketOrders.sql
*/

--use Fx
--go

--drop table EDIToyota.BlanketOrders
if	objectproperty(object_id('EDIToyota.BlanketOrders'), 'IsView') = 1 begin
	drop view EDIToyota.BlanketOrders
end
go
...
where
	oh.order_type = 'B'
	and	es.trading_partner_code like '%TMMI%'
go
