...
/*
Create Procedure.Fx.EDIToyota.usp_SendProcessEmailNotification.sql
*/

--use Fx
--go

if	objectproperty(object_id('EDIToyota.usp_SendProcessEmailNotification'), 'IsProcedure') = 1 begin
	drop procedure EDIToyota.usp_SendProcessEmailNotification
end
go
...
where
				...
				coalesce(a.releaseNo,'') = coalesce(b.releaseNo,'') and
...
Begin		
	...
	--print @emailBody
		...
		exec msdb.dbo.sp_send_dbmail
				@profile_name = 'DoNotReply'-- sysname
