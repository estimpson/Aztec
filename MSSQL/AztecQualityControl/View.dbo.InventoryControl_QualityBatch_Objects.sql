...
/*
Create table Fx.dbo.InventoryControl_QualityBatch_Objects
*/

--use Fx
--go

--drop table dbo.InventoryControl_QualityBatch_Objects
if	objectproperty(object_id('dbo.InventoryControl_QualityBatch_Objects'), 'IsView') = 1 begin
	drop view dbo.InventoryControl_QualityBatch_Objects
end
go
