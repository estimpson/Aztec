...
/*
Create procedure Fx.dbo.usp_InventoryControl_QualityBatch_SetObjectState
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_InventoryControl_QualityBatch_SetObjectState'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_InventoryControl_QualityBatch_SetObjectState
end
go
