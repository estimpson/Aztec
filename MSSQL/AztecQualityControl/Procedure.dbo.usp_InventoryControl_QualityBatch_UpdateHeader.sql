...
/*
Create procedure Fx.dbo.usp_InventoryControl_QualityBatch_UpdateHeader
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_InventoryControl_QualityBatch_UpdateHeader'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_InventoryControl_QualityBatch_UpdateHeader
end
go
