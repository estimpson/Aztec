...
/*
Create procedure Fx.dbo.usp_InventoryControl_QualityBatch_WriteObjectStatus
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_InventoryControl_QualityBatch_WriteObjectStatus'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_InventoryControl_QualityBatch_WriteObjectStatus
end
go
