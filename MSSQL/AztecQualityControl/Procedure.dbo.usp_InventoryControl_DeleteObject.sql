...
/*
Create procedure Fx.dbo.usp_InventoryControl_DeleteObject
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_InventoryControl_DeleteObject'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_InventoryControl_DeleteObject
end
go
