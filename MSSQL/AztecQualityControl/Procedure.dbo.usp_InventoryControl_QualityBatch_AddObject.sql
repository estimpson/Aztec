...
/*
Create procedure Fx.dbo.usp_InventoryControl_QualityBatch_AddObject
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_InventoryControl_QualityBatch_AddObject'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_InventoryControl_QualityBatch_AddObject
end
go
