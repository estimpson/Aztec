...
/*
Create View.FxAztec.SHIP.DepartedShipperList.sql
*/

use FxAztec
go

--drop table SHIP.DepartedShipperList
if	objectproperty(object_id('SHIP.DepartedShipperList'), 'IsView') = 1 begin
	drop view SHIP.DepartedShipperList
end
go
