...
/*
Create View.FxAztec.SHIP.EDIDocuments.sql
*/

use FxAztec
go

--drop table SHIP.EDIDocuments
if	objectproperty(object_id('SHIP.EDIDocuments'), 'IsView') = 1 begin
	drop view SHIP.EDIDocuments
end
go
