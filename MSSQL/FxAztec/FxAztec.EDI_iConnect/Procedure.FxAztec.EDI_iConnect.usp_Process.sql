...
/*
Create Procedure.FxAztec.EDI_iConnect.usp_Process.sql
*/

use FxAztec
go

if	objectproperty(object_id('EDI_iConnect.usp_Process'), 'IsProcedure') = 1 begin
	drop procedure EDI_iConnect.usp_Process
end
go
