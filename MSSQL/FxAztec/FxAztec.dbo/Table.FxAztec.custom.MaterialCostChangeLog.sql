...
/*
Create Table.FxAztec.custom.MaterialCostChangeLog.sql
*/
...
drop table custom.MaterialCostChangeLog

exec FT.sp_AddForeignKeys
*/
if	objectproperty(object_id('custom.MaterialCostChangeLog'), 'IsTable') is null begin
...
/*
Create trigger custom.tr_MaterialCostChangeLog_uRowModified on custom.MaterialCostChangeLog
*/

--use FxAztec
--go

if	objectproperty(object_id('custom.tr_MaterialCostChangeLog_uRowModified'), 'IsTrigger') = 1 begin
	drop trigger custom.tr_MaterialCostChangeLog_uRowModified
end
go
