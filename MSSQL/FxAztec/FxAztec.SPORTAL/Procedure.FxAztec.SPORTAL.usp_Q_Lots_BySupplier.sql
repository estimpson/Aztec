...
/*
Create Procedure.FxAztec.SPORTAL.usp_Q_Lots_BySupplier.sql
*/

use FxAztec
go

if	objectproperty(object_id('SPORTAL.usp_Q_Lots_BySupplier'), 'IsProcedure') = 1 begin
	drop procedure SPORTAL.usp_Q_Lots_BySupplier
end
go
