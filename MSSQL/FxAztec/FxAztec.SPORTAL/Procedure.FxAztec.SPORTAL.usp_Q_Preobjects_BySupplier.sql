...
/*
Create Procedure.FxAztec.SPORTAL.usp_Q_Preobjects_BySupplier.sql
*/

use FxAztec
go

if	objectproperty(object_id('SPORTAL.usp_Q_Preobjects_BySupplier'), 'IsProcedure') = 1 begin
	drop procedure SPORTAL.usp_Q_Preobjects_BySupplier
end
go

create procedure SPORTAL.usp_Q_Preobjects_BySupplier
...
execute
	@ProcReturn = SPORTAL.usp_Q_Preobjects_BySupplier
