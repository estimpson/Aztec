...
/*
Create Procedure.FxAztec.SPORTAL.usp_Q_Preobjects_BySupplierBatch.sql
*/

use FxAztec
go

if	objectproperty(object_id('SPORTAL.usp_Q_Preobjects_BySupplierBatch'), 'IsProcedure') = 1 begin
	drop procedure SPORTAL.usp_Q_Preobjects_BySupplierBatch
end
go

create procedure SPORTAL.usp_Q_Preobjects_BySupplierBatch
...
where
	...
	and sob.FirstSerial = @FirstSerial
	and so.Status = 0
--- </Body>
