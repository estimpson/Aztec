...
/*
Create Procedure.FxAztec.SPORTAL.usp_Preobject_ChangeQuantity.sql
*/

use FxAztec
go

if	objectproperty(object_id('SPORTAL.usp_Preobject_ChangeQuantity'), 'IsProcedure') = 1 begin
	drop procedure SPORTAL.usp_Preobject_ChangeQuantity
end
go
