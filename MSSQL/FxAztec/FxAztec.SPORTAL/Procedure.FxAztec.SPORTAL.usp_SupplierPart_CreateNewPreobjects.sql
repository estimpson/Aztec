...
/*
Create Procedure.FxAztec.SPORTAL.usp_SupplierPart_CreateNewPreobjects.sql
*/

use FxAztec
go

if	objectproperty(object_id('SPORTAL.usp_SupplierPart_CreateNewPreobjects'), 'IsProcedure') = 1 begin
	drop procedure SPORTAL.usp_SupplierPart_CreateNewPreobjects
end
go
