...
/*
Create Procedure.FxAztec.SPORTAL.usp_Q_Shipments_BySupplier.sql
*/

use FxAztec
go

if	objectproperty(object_id('SPORTAL.usp_Q_Shipments_BySupplier'), 'IsProcedure') = 1 begin
	drop procedure SPORTAL.usp_Q_Shipments_BySupplier
end
go
