...
/*
Create Procedure.FxAztec.SPORTAL.usp_SupplierShipment_RemovePreobjectList.sql
*/

use FxAztec
go

if	objectproperty(object_id('SPORTAL.usp_SupplierShipment_RemovePreobjectList'), 'IsProcedure') = 1 begin
	drop procedure SPORTAL.usp_SupplierShipment_RemovePreobjectList
end
go

create procedure SPORTAL.usp_SupplierShipment_RemovePreobjectList
...
where
	...
	(	select
		...
		where
			...
			and so.ShipperNumber = @ShipperNumber
...
execute
	@ProcReturn = SPORTAL.usp_SupplierShipment_RemovePreobjectList
