...
/*
Create Procedure.FxAztec.SPORTAL.usp_SupplierShipment_ChangeTrackingNumber.sql
*/

use FxAztec
go

if	objectproperty(object_id('SPORTAL.usp_SupplierShipment_ChangeTrackingNumber'), 'IsProcedure') = 1 begin
	drop procedure SPORTAL.usp_SupplierShipment_ChangeTrackingNumber
end
go

create procedure SPORTAL.usp_SupplierShipment_ChangeTrackingNumber
...
update
	ss
set
	ss.TrackingNumber = @TrackingNumber
from
	SPORTAL.SupplierShipments ss
where
	ss.SupplierCode = @SupplierCode
...
,	@TrackingNumber varchar(100) = '1Z125'
