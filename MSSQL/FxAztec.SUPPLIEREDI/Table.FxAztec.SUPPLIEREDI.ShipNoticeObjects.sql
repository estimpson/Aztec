...
/*
Create Table.FxAztec.SUPPLIEREDI.ShipNoticeObjects.sql
*/
...
drop table SUPPLIEREDI.ShipNoticeObjects

exec FT.sp_AddForeignKeys
*/
if	objectproperty(object_id('SUPPLIEREDI.ShipNoticeObjects'), 'IsTable') is null begin
	...
	,	foreign key
		(	RawDocumentGUID
		,	SupplierPart
		) references SUPPLIEREDI.ShipNoticeLines
		(	RawDocumentGUID
		,	SupplierPart
		)
	)
...
/*
Create trigger SUPPLIEREDI.tr_ShipNoticeObjects_uRowModified on SUPPLIEREDI.ShipNoticeObjects
*/

--use FxAztec
--go

if	objectproperty(object_id('SUPPLIEREDI.tr_ShipNoticeObjects_uRowModified'), 'IsTrigger') = 1 begin
	drop trigger SUPPLIEREDI.tr_ShipNoticeObjects_uRowModified
end
go
