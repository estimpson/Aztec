...
/*
Create Procedure.FxAztec.SUPPLIEREDI.usp_ReceivingDock_Backflush_byReceiverObjectList.sql
*/

use FxAztec
go

if	objectproperty(object_id('SUPPLIEREDI.usp_ReceivingDock_Backflush_byReceiverObjectList'), 'IsProcedure') = 1 begin
	drop procedure SUPPLIEREDI.usp_ReceivingDock_Backflush_byReceiverObjectList
end
go
