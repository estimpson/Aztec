...
/*
Create Table.FxAztec.SUPPLIEREDI.ShipNotices.sql
*/
...
drop table SUPPLIEREDI.ShipNotices

exec FT.sp_AddForeignKeys
*/
if	objectproperty(object_id('SUPPLIEREDI.ShipNotices'), 'IsTable') is null begin
...
/*
Create trigger SUPPLIEREDI.tr_ShipNotices_uRowModified on SUPPLIEREDI.ShipNotices
*/

--use FxAztec
--go

if	objectproperty(object_id('SUPPLIEREDI.tr_ShipNotices_uRowModified'), 'IsTrigger') = 1 begin
	drop trigger SUPPLIEREDI.tr_ShipNotices_uRowModified
end
go
