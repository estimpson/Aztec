...
/*
Create Procedure.FxAztec.SUPPLIEREDI.usp_ProcessReceiver_byReceiverObjectList.sql
*/

use FxAztec
go

if	objectproperty(object_id('SUPPLIEREDI.usp_ProcessReceiver_byReceiverObjectList'), 'IsProcedure') = 1 begin
	drop procedure SUPPLIEREDI.usp_ProcessReceiver_byReceiverObjectList
end
go
