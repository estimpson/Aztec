...
/*
Create procedure FxClientDB.dbo.usp_Shipping_PartPackaging_EnablePackWithWarning
*/

--use FxClientDB
--go

if	objectproperty(object_id('dbo.usp_Shipping_PartPackaging_EnablePackWithWarning'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_Shipping_PartPackaging_EnablePackWithWarning
end
go
