...
/*
Create procedure FxClientDB.dbo.usp_Shipping_PartPackaging_DisablePack
*/

--use FxClientDB
--go

if	objectproperty(object_id('dbo.usp_Shipping_PartPackaging_DisablePack'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_Shipping_PartPackaging_DisablePack
end
go

create procedure dbo.usp_Shipping_PartPackaging_DisablePack
	@ShipperID int
...
execute
	@ProcReturn = dbo.usp_Shipping_PartPackaging_DisablePack
	@ShipperID = @ShipperID
