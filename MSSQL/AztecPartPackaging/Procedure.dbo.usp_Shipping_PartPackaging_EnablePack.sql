...
/*
Create procedure FxClientDB.dbo.usp_Shipping_PartPackaging_EnablePack
*/

--use FxClientDB
--go

if	objectproperty(object_id('dbo.usp_Shipping_PartPackaging_EnablePack'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_Shipping_PartPackaging_EnablePack
end
go
