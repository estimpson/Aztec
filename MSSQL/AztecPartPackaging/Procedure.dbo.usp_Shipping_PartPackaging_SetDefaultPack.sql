...
/*
Create procedure FxClientDB.dbo.usp_Shipping_PartPackaging_SetDefaultPack
*/

--use FxClientDB
--go

if	objectproperty(object_id('dbo.usp_Shipping_PartPackaging_SetDefaultPack'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_Shipping_PartPackaging_SetDefaultPack
end
go
