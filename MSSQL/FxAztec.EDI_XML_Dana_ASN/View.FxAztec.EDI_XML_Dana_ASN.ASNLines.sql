...
/*
Create View.FxAztec.EDI_XML_Dana_ASN.ASNLines.sql
*/

use FxAztec
go

--drop table EDI_XML_Dana_ASN.ASNLines
if	objectproperty(object_id('EDI_XML_Dana_ASN.ASNLines'), 'IsView') = 1 begin
	drop view EDI_XML_Dana_ASN.ASNLines
end
go
