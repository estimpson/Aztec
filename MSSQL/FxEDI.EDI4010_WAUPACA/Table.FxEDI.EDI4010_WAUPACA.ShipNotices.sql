...
/*
Create Table.FxEDI.EDI4010_WAUPACA.ShipNotices.sql
*/
...
drop table EDI4010_WAUPACA.ShipNotices

exec FT.sp_AddForeignKeys
*/
if	objectproperty(object_id('EDI4010_WAUPACA.ShipNotices'), 'IsTable') is null begin
...
/*
Create trigger EDI4010_WAUPACA.tr_ShipNotices_uRowModified on EDI4010_WAUPACA.ShipNotices
*/

--use FxEDI
--go

if	objectproperty(object_id('EDI4010_WAUPACA.tr_ShipNotices_uRowModified'), 'IsTrigger') = 1 begin
	drop trigger EDI4010_WAUPACA.tr_ShipNotices_uRowModified
end
go
