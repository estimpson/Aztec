...
/*
Create Table.FxEDI.EDI4010_WAUPACA.ShipNoticeLines.sql
*/
...
drop table EDI4010_WAUPACA.ShipNoticeLines

exec FT.sp_AddForeignKeys
*/
if	objectproperty(object_id('EDI4010_WAUPACA.ShipNoticeLines'), 'IsTable') is null begin
...
/*
Create trigger EDI4010_WAUPACA.tr_ShipNoticeOrders_uRowModified on EDI4010_WAUPACA.ShipNoticeLines
*/
