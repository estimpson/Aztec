...
/*
Create Procedure.FxAztec.FxSYS.usp_LongPrint.sql
*/
...
if objectproperty(object_id('FxSYS.usp_LongPrint'), 'IsProcedure') = 1 begin
	drop procedure FxSYS.usp_LongPrint
end
go

create procedure FxSYS.usp_LongPrint
(	@string nvarchar(max)
)
as
	set nocount on
