...
/*
Create Procedure.FxAztec.RFR.usp_GetObjectBySerial.sql
*/

use FxAztec
go

if	objectproperty(object_id('RFR.usp_GetObjectBySerial'), 'IsProcedure') = 1 begin
	drop procedure RFR.usp_GetObjectBySerial
end
go
