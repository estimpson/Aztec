...
/*
Create Procedure.FxAztec.RFR.usp_GetInternalSerialByLicensePlate.sql
*/

use FxAztec
go

if	objectproperty(object_id('RFR.usp_GetInternalSerialByLicensePlate'), 'IsProcedure') = 1 begin
	drop procedure RFR.usp_GetInternalSerialByLicensePlate
end
go
