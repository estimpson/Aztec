...
/*
Create Procedure.Fx.dbo.usp_SQA_UnstageObject.sql
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_SQA_UnstageObject'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_SQA_UnstageObject
end
go
