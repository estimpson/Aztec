...
/*
Create Procedure.Fx.dbo.usp_SQA_SetPartAlert.sql
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_SQA_SetPartAlert'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_SQA_SetPartAlert
end
go

create procedure dbo.usp_SQA_SetPartAlert
	@User varchar(5)
,	@PartCode varchar(25)
,	@EnabledFlag int
...
execute
	@ProcReturn = dbo.usp_SQA_SetPartAlert
	@Param1 = @Param1
,	@TranDT = @TranDT out
