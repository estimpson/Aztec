CREATE TABLE [EDI3060].[ReleasePlanSupplemental]
(
[Status] [int] NOT NULL CONSTRAINT [DF__ReleasePl__Statu__30592A6F] DEFAULT ((0)),
[Type] [int] NOT NULL CONSTRAINT [DF__ReleasePla__Type__314D4EA8] DEFAULT ((0)),
...
[RowCreateDT] [datetime] NULL CONSTRAINT [DF__ReleasePl__RowCr__324172E1] DEFAULT (getdate()),
[RowCreateUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ReleasePl__RowCr__3335971A] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__ReleasePl__RowMo__3429BB53] DEFAULT (getdate()),
[RowModifiedUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ReleasePl__RowMo__351DDF8C] DEFAULT (suser_name())
) ON [PRIMARY]
GO
...
create trigger [EDI3060].[tr_ReleasePlanSupplemental_uRowModified] on [EDI3060].[ReleasePlanSupplemental] after update
as
declare
	@TranDT datetime
,	@Result int
...
begin try
	...
	if	not update(RowModifiedDT) begin
		--- <Update rows="*">
		set	@TableName = 'EDI3060.ReleasePlanSupplemental'
		...
		from
			EDI3060.ReleasePlanSupplemental rps
			join inserted i
...
insert
	EDI3060.ReleasePlanSupplemental
...
...
*/
GO
ALTER TABLE [EDI3060].[ReleasePlanSupplemental] ADD CONSTRAINT [PK__ReleaseP__FFEE7451F774D41C] PRIMARY KEY CLUSTERED  ([RowID]) ON [PRIMARY]
GO
