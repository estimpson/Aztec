CREATE TABLE [EDI3060].[ShipScheduleSupplemental]
(
[Status] [int] NOT NULL CONSTRAINT [DF__ShipSched__Statu__5B438874] DEFAULT ((0)),
[Type] [int] NOT NULL CONSTRAINT [DF__ShipSchedu__Type__5C37ACAD] DEFAULT ((0)),
...
[RowCreateDT] [datetime] NULL CONSTRAINT [DF__ShipSched__RowCr__5D2BD0E6] DEFAULT (getdate()),
[RowCreateUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ShipSched__RowCr__5E1FF51F] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__ShipSched__RowMo__5F141958] DEFAULT (getdate()),
[RowModifiedUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ShipSched__RowMo__60083D91] DEFAULT (suser_name())
) ON [PRIMARY]
GO
...
create trigger [EDI3060].[tr_ShipScheduleSupplemental_uRowModified] on [EDI3060].[ShipScheduleSupplemental] after update
as
declare
	@TranDT datetime
,	@Result int
...
*/
GO
ALTER TABLE [EDI3060].[ShipScheduleSupplemental] ADD CONSTRAINT [PK__ShipSche__FFEE7451F671A4D7] PRIMARY KEY CLUSTERED  ([RowID]) ON [PRIMARY]
GO
