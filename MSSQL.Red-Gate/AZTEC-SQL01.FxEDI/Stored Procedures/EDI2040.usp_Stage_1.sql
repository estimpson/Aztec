...
SET ANSI_NULLS ON
GO
CREATE procedure [EDI2040].[usp_Stage_1]
...
if	exists
	(	select
		...
		where
			ed.Type = '862'
			and  left(ed.EDIStandard,6) = '002040' 
...
select
	...
	,	SupplierCode	
	,	CustomerPart = ed.Data.value('(	for $a in LOOP-LIN/SEG-LIN/DE[@code="0235"] where $a="BP" return $a/../DE[. >> $a][@code="0234"][1])[1]', 'varchar(30)')
	,	CustomerPO = coalesce(ed.Data.value('(	for $a in LOOP-LIN/SEG-LIN/DE[@code="0235"] where $a="PO" return $a/../DE[. >> $a][@code="0234"][1])[1]', 'varchar(30)'), 
													ed.Data.value('(	for $a in LOOP-LIN/SEG-REF/DE[@code="0128"] where $a="PO" return $a/../DE[. >> $a][@code="0127"][1])[1]', 'varchar(30)')	)
	, CustomerPOLine = ed.Data.value('(	for $a in LOOP-LIN/SEG-LIN/DE[@code="0235"] where $a="PL" return $a/../DE[. >> $a][@code="0234"][1])[1]', 'varchar(30)')
	,	CustomerModelYear = ''
	,	CustomerECL = ''
	,	Data = EDIData.Data.query('.')
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI2040.StagingShipScheduleHeaders'

	insert
		FxAztec.EDI2040.StagingShipScheduleHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI2040.StagingShipScheduleSupplemental'
	
	insert 
		FxAztec.EDI2040.StagingShipScheduleSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI2040.StagingShipScheduleAccums'

	insert  FxAztec.EDI2040.StagingShipScheduleAccums
    (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI2040.StagingShipScheduleAuthAccums'

	insert
		FxAztec.EDI2040.StagingShipScheduleAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI2040.StagingShipSchedules'

	insert
		FxAztec.EDI2040.StagingShipSchedules
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI2040.StagingPlanningHeaders'

	insert
		FxAztec.EDI2040.StagingPlanningHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	insert 
		FxAztec.EDI2040.StagingPlanningSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI2040.StagingPlanningAccums'

	insert
		FxAztec.EDI2040.StagingPlanningAccums
	 (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI2040.StagingPlanningAuthAccums'

	insert
		FxAztec.EDI2040.StagingPlanningAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI2040.StagingPlanningReleases'

	insert
		FxAztec.EDI2040.StagingPlanningReleases
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
set	@Result = 100
	raiserror ('Chrysler documents already in process.  Use EDI2040.usp_ClearQueue to clear the queue if necessary.', 16, 1)
	return
...
execute
	@ProcReturn = EDI2040.usp_Stage_1
	@TranDT = @TranDT out
...
select
	*
from
	FxAztec.EDI2040.StagingShipScheduleHeaders sfh

Select 'StagingSSchedules'
select
	*
from
	FxAztec.EDI2040.StagingShipSchedules sfr

Select 'StagingSSAccums'
select 
	*
from
	FxAztec.EDI2040.StagingShipScheduleAccums sfs

Select 'StagingSSSupplemental'
select 
	*
from
	FxAztec.EDI2040.StagingShipScheduleSupplemental sfs
go
...
select
	*
from
	FxAztec.EDI2040.StagingPlanningHeaders sfh

Select 'PlanningReleases'
select
	*
from
	FxAztec.EDI2040.StagingPlanningReleases sfr

Select 'PlanningAccums'	
select 
	*
from
	FxAztec.EDI2040.StagingPlanningAccums sfa
Select 'PlanningAuthAccums'	

select 
	*
from
	FxAztec.EDI2040.StagingPlanningAuthAccums sfa

Select 'PlanningSupplemental'	
select 
	*
from
	FxAztec.EDI2040.StagingPlanningSupplemental sfa
