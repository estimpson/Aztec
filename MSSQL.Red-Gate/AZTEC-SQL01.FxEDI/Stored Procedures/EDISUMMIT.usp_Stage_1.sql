...
CREATE PROCEDURE [EDISUMMIT].[usp_Stage_1]
...
--- <Update rows="*">
set	@TableName = 'EDISUMMIT.vwPlanningReleasesHeaders'
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDISUMMIT.StagingShipScheduleHeaders'

	insert
		FxAztec.EDISUMMIT.StagingShipScheduleHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDISUMMIT.StagingShipScheduleSupplemental'
	
	insert 
		FxAztec.EDISUMMIT.StagingShipScheduleSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDISUMMIT.StagingShipScheduleAccums'

	insert  FxAztec.EDISUMMIT.StagingShipScheduleAccums
    (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDISUMMIT.StagingShipScheduleAuthAccums'

	insert
		FxAztec.EDISUMMIT.StagingShipScheduleAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDISUMMIT.StagingShipSchedules'

	insert
		FxAztec.EDISUMMIT.StagingShipSchedules
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDISUMMIT.StagingPlanningHeaders'

	insert
		FxAztec.EDISUMMIT.StagingPlanningHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	insert 
		FxAztec.EDISUMMIT.StagingPlanningSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDISUMMIT.StagingPlanningAccums'

	insert
		FxAztec.EDISUMMIT.StagingPlanningAccums
	 (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDISUMMIT.StagingPlanningAuthAccums'

	insert
		FxAztec.EDISUMMIT.StagingPlanningAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDISUMMIT.StagingPlanningReleases'

	insert
		FxAztec.EDISUMMIT.StagingPlanningReleases
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
SET	@Result = 100
	RAISERROR ('97A documents already in process.  Use EDISUMMIT.usp_ClearQueue to clear the queue if necessary.', 16, 1)
	RETURN
...
execute
	@ProcReturn = EDISUMMIT.usp_Stage_1
	@TranDT = @TranDT out
...
select
	*
from
	FxAztec.EDISUMMIT.StagingShipScheduleHeaders sfh

Select 'StagingSSchedules'
select
	*
from
	FxAztec.EDISUMMIT.StagingShipSchedules sfr

Select 'StagingSSAccums'
select 
	*
from
	FxAztec.EDISUMMIT.StagingShipScheduleAccums sfs

Select 'StagingSSAuthAccums'
select 
	*
from
	FxAztec.EDISUMMIT.StagingShipScheduleAuthAccums sfs

Select 'StagingSSSupplemental'
select 
	*
from
	FxAztec.EDISUMMIT.StagingShipScheduleSupplemental sfs
go
...
select
	*
from
	FxAztec.EDISUMMIT.StagingPlanningHeaders sfh

Select 'PlanningReleases'
select
	*
from
	FxAztec.EDISUMMIT.StagingPlanningReleases sfr

Select 'PlanningAccums'	
select 
	*
from
	FxAztec.EDISUMMIT.StagingPlanningAccums sfa

Select 'PlanningAuthAccums'	
select 
	*
from
	FxAztec.EDISUMMIT.StagingPlanningAuthAccums sfa
Select 'PlanningSupplemental'	
select 
	*
from
	FxAztec.EDISUMMIT.StagingPlanningSupplemental sfa
