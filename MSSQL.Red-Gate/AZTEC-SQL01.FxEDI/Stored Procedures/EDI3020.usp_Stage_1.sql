...
CREATE procedure [EDI3020].[usp_Stage_1]
...
if	exists
	(	select
		...
		where
			ed.Type = '862'
			and  left(ed.EDIStandard,6) = '003020' 
...
insert
	...
	from
		@PlanningReleasesTemp1 ed
		cross apply ed.Data.nodes('/LOOP-LIN/LOOP-FST/SEG-FST') as EDIData(Data)
	order by
		2
	,	3
	,	7
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3020.StagingShipScheduleHeaders'

	insert
		FxAztec.EDI3020.StagingShipScheduleHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3020.StagingShipScheduleSupplemental'
	
	insert 
		FxAztec.EDI3020.StagingShipScheduleSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3020.StagingShipScheduleAccums'

	insert  FxAztec.EDI3020.StagingShipScheduleAccums
    (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3020.StagingShipScheduleAuthAccums'

	insert
		FxAztec.EDI3020.StagingShipScheduleAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3020.StagingShipSchedules'

	insert
		FxAztec.EDI3020.StagingShipSchedules
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3020.StagingPlanningHeaders'

	insert
		FxAztec.EDI3020.StagingPlanningHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	insert 
		FxAztec.EDI3020.StagingPlanningSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3020.StagingPlanningAccums'

	insert
		FxAztec.EDI3020.StagingPlanningAccums
	 (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3020.StagingPlanningAuthAccums'

	insert
		FxAztec.EDI3020.StagingPlanningAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3020.StagingPlanningReleases'

	INSERT
		FxAztec.EDI3020.StagingPlanningReleases
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
SET	@Result = 100
	RAISERROR ('Chrysler documents already in process.  Use EDI3020.usp_ClearQueue to clear the queue if necessary.', 16, 1)
	RETURN
...
execute
	@ProcReturn = EDI3020.usp_Stage_1
	@TranDT = @TranDT out
...
select
	*
from
	FxAztec.EDI3020.StagingShipScheduleHeaders sfh

Select 'StagingSSchedules'
select
	*
from
	FxAztec.EDI3020.StagingShipSchedules sfr

Select 'StagingSSAccums'
select 
	*
from
	FxAztec.EDI3020.StagingShipScheduleAccums sfs

Select 'StagingSSSupplemental'
select 
	*
from
	FxAztec.EDI3020.StagingShipScheduleSupplemental sfs
go
...
select
	*
from
	FxAztec.EDI3020.StagingPlanningHeaders sfh

Select 'PlanningReleases'
select
	*
from
	FxAztec.EDI3020.StagingPlanningReleases sfr

Select 'PlanningAccums'	
select 
	*
from
	FxAztec.EDI3020.StagingPlanningAccums sfa
Select 'PlanningAuthAccums'	

select 
	*
from
	FxAztec.EDI3020.StagingPlanningAuthAccums sfa

Select 'PlanningSupplemental'	
select 
	*
from
	FxAztec.EDI3020.StagingPlanningSupplemental sfa
