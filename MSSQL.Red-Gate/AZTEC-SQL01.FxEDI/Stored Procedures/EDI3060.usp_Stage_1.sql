...
CREATE procedure [EDI3060].[usp_Stage_1]
...
if	exists
	(	select
		...
		where
			ed.Type = '862'
			and  left(ed.EDIStandard,6) = '003060' 
...
select
	...
	,	ShipToCode = coalesce(EDIData.Releases.value('(./SEG-REF [DE[.="DK"][@code="0128"]]/DE[@code="0127"])[1]', 'varchar(50)'), EDIData.Releases.value('(../SEG-N1 [DE[.="ST"][@code="0098"]]/DE[@code="0067"])[1]', 'varchar(50)'),ed.Data.value('(/TRN-862/LOOP-N1/SEG-N1 [DE[.="ST"][@code="0098"]]/DE[@code="0067"])[1]', 'varchar(50)'))
	...
	from
		...
		cross apply ed.data.nodes('/LOOP-LIN/LOOP-RFF') as EDIData(Data)
	order by
		2
	,	3
	,	7
...
declare
	...
	from
		...
		cross apply ed.Data.nodes('/LOOP-LIN/LOOP-FST') as EDIData(Data)
	order by
		2
	,	3
	,	7
	...
	,	UserDefined4 = ''
	,	UserDefined5 = ''
	,	DateDue = Data.value('(/LOOP-FST/SEG-FST/DE[@code="0373"])[1]', 'varchar(50)')
	,	QuantityDue = Data.value('(/LOOP-FST/SEG-FST/DE[@code="0380"])[1]', 'varchar(50)')
	,	QuantityType = Data.value('(/LOOP-FST/SEG-FST/DE[@code="0680"])[1]', 'varchar(50)')
...
/*			- prepare Release Plans Supplemental.*/
	...
	select
		RawDocumentGUID
	,	ReleaseNo = coalesce(nullif(ed.Data.value('(/TRN-830/SEG-BFR/DE[@code="0328"])[1]', 'varchar(30)'),''), ed.Data.value('(/TRN-830/SEG-BFR/DE[@code="0127"])[1]', 'varchar(30)'))
,	ShipToCode = coalesce(EDIData.Releases.value('(./LOOP-N1/SEG-N1 [DE[.="ST"][@code="0098"]]/DE[@code="0067"])[1]', 'varchar(50)'),ed.Data.value('(/TRN-830/LOOP-N1/SEG-N1 [DE[.="ST"][@code="0098"]]/DE[@code="0067"])[1]', 'varchar(50)'), ed.Data.value('/*[1]/TRN-INFO[1]/@trading_partner', 'varchar(50)'))
...
select
	...
	,	ReceivedAccum = Data.value('(for $a in LOOP-SHP/SEG-SHP/DE[@code="0673"] where $a="02" return $a/../DE[. >> $a][@code="0380"][1])[1]', 'varchar(30)')
	,	ReceivedAccumBeginDT = Data.value('(for $a in LOOP-SHP/SEG-SHP/DE[@code="0374"] where $a="051" return $a/../DE[. >> $a][@code="0373"][1])[1]', 'varchar(30)')
	,	ReceivedAccumEndDT = coalesce(Data.value('(for $a in LOOP-SHP/SEG-SHP/DE[@code="0374"] where $a="052" return $a/../DE[. >> $a][@code="0373"][1])[1]', 'varchar(30)'), Data.value('(for $a in LOOP-SHP/SEG-SHP/DE[@code="0374"] where $a="050" return $a/../DE[. >> $a][@code="0373"][1])[1]', 'varchar(30)'))
	,	ReceivedQty = Data.value('(for $a in LOOP-SHP/SEG-SHP/DE[@code="0673"] where $a="01" return $a/../DE[. >> $a][@code="0380"][1])[1]', 'varchar(30)')
...
insert
	...
	from
		@PlanningReleasesTemp1 ed
		cross apply ed.Data.nodes('/LOOP-LIN/LOOP-SDP/LOOP-JIT/SEG-JIT') as EDIData(Data)
	order by
		2
	,	3
	,	7
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3060.StagingShipScheduleHeaders'

	insert
		FxAztec.EDI3060.StagingShipScheduleHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3060.StagingShipScheduleSupplemental'
	
	insert 
		FxAztec.EDI3060.StagingShipScheduleSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3060.StagingShipScheduleAccums'

	insert  FxAztec.EDI3060.StagingShipScheduleAccums
    (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3060.StagingShipScheduleAuthAccums'

	insert
		FxAztec.EDI3060.StagingShipScheduleAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3060.StagingShipSchedules'

	insert
		FxAztec.EDI3060.StagingShipSchedules
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3060.StagingPlanningHeaders'

	insert
		FxAztec.EDI3060.StagingPlanningHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	insert 
		FxAztec.EDI3060.StagingPlanningSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3060.StagingPlanningAccums'

	insert
		FxAztec.EDI3060.StagingPlanningAccums
	 (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3060.StagingPlanningAuthAccums'

	insert
		FxAztec.EDI3060.StagingPlanningAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3060.StagingPlanningReleases'

	insert
		FxAztec.EDI3060.StagingPlanningReleases
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
set	@Result = 100
	raiserror ('Chrysler documents already in process.  Use EDI3060.usp_ClearQueue to clear the queue if necessary.', 16, 1)
	return
...
execute
	@ProcReturn = EDI3060.usp_Stage_1
	@TranDT = @TranDT out
...
select
	*
from
	FxAztec.EDI3060.StagingShipScheduleHeaders sfh

Select 'StagingSSchedules'
select
	*
from
	FxAztec.EDI3060.StagingShipSchedules sfr

Select 'StagingSSAccums'
select 
	*
from
	FxAztec.EDI3060.StagingShipScheduleAccums sfs

Select 'StagingSSSupplemental'
select 
	*
from
	FxAztec.EDI3060.StagingShipScheduleSupplemental sfs
go
...
select
	*
from
	FxAztec.EDI3060.StagingPlanningHeaders sfh

Select 'PlanningReleases'
select
	*
from
	FxAztec.EDI3060.StagingPlanningReleases sfr

Select 'PlanningAccums'	
select 
	*
from
	FxAztec.EDI3060.StagingPlanningAccums sfa
Select 'PlanningAuthAccums'	

select 
	*
from
	FxAztec.EDI3060.StagingPlanningAuthAccums sfa

Select 'PlanningSupplemental'	
select 
	*
from
	FxAztec.EDI3060.StagingPlanningSupplemental sfa
