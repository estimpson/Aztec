...
declare
	...
	select
		RawDocumentGUID = ed.GUID
	,	ReleaseNo =	coalesce(	ed.Data.value('(/TRN-DELJIT/SEG-BGM/CE/DE[@code="1004"])[1]', 'varchar(50)'), ed.Data.value('(/TRN-DELJIT/SEG-BGM[1]/CE/DE[@code="1001"])[1]', 'varchar(50)'),'')
...
declare
	...
	select
		RawDocumentGUID = ed.GUID
	,	ReleaseNo =		coalesce(	ed.Data.value('(/TRN-DELFOR/SEG-BGM/DE[@code="1004"])[1]', 'varchar(50)'), ed.Data.value('(/TRN-DELFOR/SEG-BGM/DE[@code="1004"])[1]', 'varchar(50)'),'')
	,	ShipToCode =	coalesce(	EDIData.Releases.value('(../LOOP-NAD/SEG-NAD [DE[.="ST"][@code="3035"]]/CE/DE[@code="3039"])[1]', 'varchar(15)')	,ed.Data.value('(/TRN-DELFOR/LOOP-NAD/SEG-NAD [DE[.="SA"][@code="3035"]]/CE/DE[@code="3039"])[1]', 'varchar(15)'))
	...
	from
		EDI.EDIDocuments ed
		cross apply ed.Data.nodes('/TRN-DELFOR/LOOP-NAD[./LOOP-LIN[*]]') as EDIData(Releases)
	where
		ed.HeaderData.value('/TRN-INFO[1]/@type', 'varchar(50)') = 'DELFOR'
		and ed.EDIStandard = '96A'
		and ed.Status = 100 -- (select dbo.udf_StatusValue('EDI.EDIDocuments', 'InProcess'))
...
declare
	...
	select
		RawDocumentGUID = ed.GUID
	,	ReleaseNo =		coalesce(	ed.Data.value('(/TRN-DELFOR/SEG-BGM/DE[@code="1004"])[1]', 'varchar(50)'), ed.Data.value('(/TRN-DELFOR/SEG-BGM/CE/DE[@code="1004"])[1]', 'varchar(50)'),'')
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDIEDIFACT96A.StagingShipScheduleHeaders'

	insert
		FxAztec.EDIEDIFACT96A.StagingShipScheduleHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDIEDIFACT96A.StagingShipScheduleSupplemental'
	
	insert 
		FxAztec.EDIEDIFACT96A.StagingShipScheduleSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDIEDIFACT96A.StagingShipScheduleAccums'

	insert  FxAztec.EDIEDIFACT96A.StagingShipScheduleAccums
    (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDIEDIFACT96A.StagingShipScheduleAuthAccums'

	insert
		FxAztec.EDIEDIFACT96A.StagingShipScheduleAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDIEDIFACT96A.StagingShipSchedules'

	insert
		FxAztec.EDIEDIFACT96A.StagingShipSchedules
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDIEDIFACT96A.StagingPlanningHeaders'

	insert
		FxAztec.EDIEDIFACT96A.StagingPlanningHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	insert 
		FxAztec.EDIEDIFACT96A.StagingPlanningSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDIEDIFACT96A.StagingPlanningAccums'

	insert
		FxAztec.EDIEDIFACT96A.StagingPlanningAccums
	 (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDIEDIFACT96A.StagingPlanningAuthAccums'

	insert
		FxAztec.EDIEDIFACT96A.StagingPlanningAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDIEDIFACT96A.StagingPlanningReleases'

	insert
		FxAztec.EDIEDIFACT96A.StagingPlanningReleases
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
select
	*
from
	FxAztec.EDIEDIFACT96A.StagingShipScheduleHeaders sfh

Select 'StagingSSchedules'
select
	*
from
	FxAztec.EDIEDIFACT96A.StagingShipSchedules sfr

Select 'StagingSSAccums'
select 
	*
from
	FxAztec.EDIEDIFACT96A.StagingShipScheduleAccums sfs

Select 'StagingSSAuthAccums'
select 
	*
from
	FxAztec.EDIEDIFACT96A.StagingShipScheduleAuthAccums sfs

Select 'StagingSSSupplemental'
select 
	*
from
	FxAztec.EDIEDIFACT96A.StagingShipScheduleSupplemental sfs
go
...
select
	*
from
	FxAztec.EDIEDIFACT96A.StagingPlanningHeaders sfh

Select 'PlanningReleases'
select
	*
from
	FxAztec.EDIEDIFACT96A.StagingPlanningReleases sfr

Select 'PlanningAccums'	
select 
	*
from
	FxAztec.EDIEDIFACT96A.StagingPlanningAccums sfa

Select 'PlanningAuthAccums'	
select 
	*
from
	FxAztec.EDIEDIFACT96A.StagingPlanningAuthAccums sfa
Select 'PlanningSupplemental'	
select 
	*
from
	FxAztec.EDIEDIFACT96A.StagingPlanningSupplemental sfa
