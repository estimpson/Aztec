...
IF	EXISTS
	(	SELECT
		...
		WHERE
			ed.Type = '862'
			AND  LEFT(ed.EDIStandard,6) = '004010' 
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI4010.StagingShipScheduleHeaders'

	insert
		FxAztec.EDI4010.StagingShipScheduleHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI4010.StagingShipScheduleSupplemental'
	
	insert 
		FxAztec.EDI4010.StagingShipScheduleSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI4010.StagingShipScheduleAccums'

	insert  FxAztec.EDI4010.StagingShipScheduleAccums
    (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI4010.StagingShipScheduleAuthAccums'

	insert
		FxAztec.EDI4010.StagingShipScheduleAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI4010.StagingShipSchedules'

	insert
		FxAztec.EDI4010.StagingShipSchedules
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI4010.StagingPlanningHeaders'

	insert
		FxAztec.EDI4010.StagingPlanningHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	insert 
		FxAztec.EDI4010.StagingPlanningSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI4010.StagingPlanningAccums'

	insert
		FxAztec.EDI4010.StagingPlanningAccums
	 (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI4010.StagingPlanningAuthAccums'

	insert
		FxAztec.EDI4010.StagingPlanningAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI4010.StagingPlanningReleases'

	INSERT
		FxAztec.EDI4010.StagingPlanningReleases
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
SET	@Result = 100
	RAISERROR ('Chrysler documents already in process.  Use EDI4010.usp_ClearQueue to clear the queue if necessary.', 16, 1)
	RETURN
...
execute
	@ProcReturn = EDI4010.usp_Stage_1
	@TranDT = @TranDT out
...
select
	*
from
	FxAztec.EDI4010.StagingShipScheduleHeaders sfh

Select 'StagingSSchedules'
select
	*
from
	FxAztec.EDI4010.StagingShipSchedules sfr

Select 'StagingSSAccums'
select 
	*
from
	FxAztec.EDI4010.StagingShipScheduleAccums sfs

Select 'StagingSSSupplemental'
select 
	*
from
	FxAztec.EDI4010.StagingShipScheduleSupplemental sfs
go
...
select
	*
from
	FxAztec.EDI4010.StagingPlanningHeaders sfh

Select 'PlanningReleases'
select
	*
from
	FxAztec.EDI4010.StagingPlanningReleases sfr

Select 'PlanningAccums'	
select 
	*
from
	FxAztec.EDI4010.StagingPlanningAccums sfa
Select 'PlanningAuthAccums'	

select 
	*
from
	FxAztec.EDI4010.StagingPlanningAuthAccums sfa

Select 'PlanningSupplemental'	
select 
	*
from
	FxAztec.EDI4010.StagingPlanningSupplemental sfa
