...
CREATE procedure [EDICHRY].[usp_Stage_1_bak]
...
/*			- prepare Release Plans Supplemental.*/
	...
	where
		ed.Type = '830'
		and  left(ed.EDIStandard,6) = '00CHRY' 
		--and GUID = '42DBE19D-29D8-E211-BD0E-001E6746D5DD'
		--and ed.TradingPartner in ( 'MPT MUNCIE' )
		and ed.Status = 100 -- (select dbo.udf_StatusValue('EDI.EDIDocuments', 'InProcess'))
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDICHRY.StagingShipScheduleHeaders'

	insert
		FxAztec.EDICHRY.StagingShipScheduleHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDICHRY.StagingShipScheduleSupplemental'
	
	insert 
		FxAztec.EDICHRY.StagingShipScheduleSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDICHRY.StagingShipScheduleAccums'

	insert  FxAztec.EDICHRY.StagingShipScheduleAccums
    (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDICHRY.StagingShipScheduleAuthAccums'

	insert
		FxAztec.EDICHRY.StagingShipScheduleAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDICHRY.StagingShipSchedules'

	insert
		FxAztec.EDICHRY.StagingShipSchedules
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDICHRY.StagingPlanningHeaders'

	insert
		FxAztec.EDICHRY.StagingPlanningHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	insert 
		FxAztec.EDICHRY.StagingPlanningSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDICHRY.StagingPlanningAccums'

	insert
		FxAztec.EDICHRY.StagingPlanningAccums
	 (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDICHRY.StagingPlanningAuthAccums'

	insert
		FxAztec.EDICHRY.StagingPlanningAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDICHRY.StagingPlanningReleases'

	insert
		FxAztec.EDICHRY.StagingPlanningReleases
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
select
	*
from
	FxAztec.EDICHRY.StagingShipScheduleHeaders sfh

Select 'StagingSSchedules'
select
	*
from
	FxAztec.EDICHRY.StagingShipSchedules sfr

Select 'StagingSSAccums'
select 
	*
from
	FxAztec.EDICHRY.StagingShipScheduleAccums sfs

Select 'StagingSSSupplemental'
select 
	*
from
	FxAztec.EDICHRY.StagingShipScheduleSupplemental sfs
go
...
select
	*
from
	FxAztec.EDICHRY.StagingPlanningHeaders sfh

Select 'PlanningReleases'
select
	*
from
	FxAztec.EDICHRY.StagingPlanningReleases sfr

Select 'PlanningAccums'	
select 
	*
from
	FxAztec.EDICHRY.StagingPlanningAccums sfa
Select 'PlanningAuthAccums'	

select 
	*
from
	FxAztec.EDICHRY.StagingPlanningAuthAccums sfa

Select 'PlanningSupplemental'	
select 
	*
from
	FxAztec.EDICHRY.StagingPlanningSupplemental sfa
