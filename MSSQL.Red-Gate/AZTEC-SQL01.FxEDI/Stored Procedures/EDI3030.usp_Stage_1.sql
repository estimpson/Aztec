...
CREATE procedure [EDI3030].[usp_Stage_1]
...
if	exists
	(	select
		...
		where
			ed.Type = '862'
			and  left(ed.EDIStandard,6) = '003030' 
...
insert
	...
	,	UserDefined3 = ''
	,	UserDefined4 = ''
	,	UserDefined5 = Data.value('(/SEG-FST/DE[@code="0127"])[1]', 'varchar(50)')
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3030.StagingShipScheduleHeaders'

	insert
		FxAztec.EDI3030.StagingShipScheduleHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3030.StagingShipScheduleSupplemental'
	
	insert 
		FxAztec.EDI3030.StagingShipScheduleSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3030.StagingShipScheduleAccums'

	insert  FxAztec.EDI3030.StagingShipScheduleAccums
    (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3030.StagingShipScheduleAuthAccums'

	insert
		FxAztec.EDI3030.StagingShipScheduleAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3030.StagingShipSchedules'

	insert
		FxAztec.EDI3030.StagingShipSchedules
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3030.StagingPlanningHeaders'

	insert
		FxAztec.EDI3030.StagingPlanningHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	insert 
		FxAztec.EDI3030.StagingPlanningSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3030.StagingPlanningAccums'

	insert
		FxAztec.EDI3030.StagingPlanningAccums
	 (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3030.StagingPlanningAuthAccums'

	insert
		FxAztec.EDI3030.StagingPlanningAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3030.StagingPlanningReleases'

	insert
		FxAztec.EDI3030.StagingPlanningReleases
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
set	@Result = 100
	raiserror ('Chrysler documents already in process.  Use EDI3030.usp_ClearQueue to clear the queue if necessary.', 16, 1)
	return
...
execute
	@ProcReturn = EDI3030.usp_Stage_1
	@TranDT = @TranDT out
...
select
	*
from
	FxAztec.EDI3030.StagingShipScheduleHeaders sfh

Select 'StagingSSchedules'
select
	*
from
	FxAztec.EDI3030.StagingShipSchedules sfr

Select 'StagingSSAccums'
select 
	*
from
	FxAztec.EDI3030.StagingShipScheduleAccums sfs

Select 'StagingSSSupplemental'
select 
	*
from
	FxAztec.EDI3030.StagingShipScheduleSupplemental sfs
go
...
select
	*
from
	FxAztec.EDI3030.StagingPlanningHeaders sfh

Select 'PlanningReleases'
select
	*
from
	FxAztec.EDI3030.StagingPlanningReleases sfr

Select 'PlanningAccums'	
select 
	*
from
	FxAztec.EDI3030.StagingPlanningAccums sfa
Select 'PlanningAuthAccums'	

select 
	*
from
	FxAztec.EDI3030.StagingPlanningAuthAccums sfa

Select 'PlanningSupplemental'	
select 
	*
from
	FxAztec.EDI3030.StagingPlanningSupplemental sfa
