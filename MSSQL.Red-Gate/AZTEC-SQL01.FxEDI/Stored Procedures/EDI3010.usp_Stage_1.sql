...
SET ANSI_NULLS ON
GO
CREATE procedure [EDI3010].[usp_Stage_1]
...
if	exists
	(	select
		...
		where
			ed.Type = '862'
			and  left(ed.EDIStandard,6) = '003010' 
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3010.StagingShipScheduleHeaders'

	insert
		FxAztec.EDI3010.StagingShipScheduleHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3010.StagingShipScheduleSupplemental'
	
	insert 
		FxAztec.EDI3010.StagingShipScheduleSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3010.StagingShipScheduleAccums'

	insert  FxAztec.EDI3010.StagingShipScheduleAccums
    (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3010.StagingShipScheduleAuthAccums'

	insert
		FxAztec.EDI3010.StagingShipScheduleAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3010.StagingShipSchedules'

	insert
		FxAztec.EDI3010.StagingShipSchedules
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3010.StagingPlanningHeaders'

	insert
		FxAztec.EDI3010.StagingPlanningHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	insert 
		FxAztec.EDI3010.StagingPlanningSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3010.StagingPlanningAccums'

	insert
		FxAztec.EDI3010.StagingPlanningAccums
	 (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3010.StagingPlanningAuthAccums'

	insert
		FxAztec.EDI3010.StagingPlanningAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI3010.StagingPlanningReleases'

	insert
		FxAztec.EDI3010.StagingPlanningReleases
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
set	@Result = 100
	raiserror ('Chrysler documents already in process.  Use EDI3010.usp_ClearQueue to clear the queue if necessary.', 16, 1)
	return
...
execute
	@ProcReturn = EDI3010.usp_Stage_1
	@TranDT = @TranDT out
...
select
	*
from
	FxAztec.EDI3010.StagingShipScheduleHeaders sfh

Select 'StagingSSchedules'
select
	*
from
	FxAztec.EDI3010.StagingShipSchedules sfr

Select 'StagingSSAccums'
select 
	*
from
	FxAztec.EDI3010.StagingShipScheduleAccums sfs

Select 'StagingSSSupplemental'
select 
	*
from
	FxAztec.EDI3010.StagingShipScheduleSupplemental sfs
go
...
select
	*
from
	FxAztec.EDI3010.StagingPlanningHeaders sfh

Select 'PlanningReleases'
select
	*
from
	FxAztec.EDI3010.StagingPlanningReleases sfr

Select 'PlanningAccums'	
select 
	*
from
	FxAztec.EDI3010.StagingPlanningAccums sfa
Select 'PlanningAuthAccums'	

select 
	*
from
	FxAztec.EDI3010.StagingPlanningAuthAccums sfa

Select 'PlanningSupplemental'	
select 
	*
from
	FxAztec.EDI3010.StagingPlanningSupplemental sfa
