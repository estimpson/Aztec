...
CREATE procedure [EDI].[usp_FTP_SendCustomerEDI(obsolete)]
...
/*	Update the location of the moved file(s) in the file generation log.*/
update
	cegl
...
execute
	@ProcReturn = EDI.usp_FTP_SendCustomerEDI
	@TranDT = @TranDT out
,	@Result = @ProcResult out
