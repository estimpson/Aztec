...
create procedure [EDIToyota].[usp_StageShipSchedules]
...
begin
	...
	begin try
		...
		begin
			insert
				FxAztec.EDIToyota.ShipScheduleHeaders
			(	RawDocumentGUID
			,	DocumentImportDT
			,	TradingPartner
			,	DocType
			...
			insert
				FxAztec.EDIToyota.ShipScheduleSupplemental
			(	RawDocumentGUID
			,	ReleaseNo
			,	ShipToCode
			,	ConsigneeCode
			...
			insert
				FxAztec.EDIToyota.ShipScheduleAccums
			(	RawDocumentGUID
			,	ReleaseNo
			,	ShipToCode
			,	ConsigneeCode
			...
			insert
				FxAztec.EDIToyota.ShipScheduleAuthAccums
			(	RawDocumentGUID
			,	ReleaseNo
			,	ShipToCode
			,	ConsigneeCode
			...
			insert
				FxAztec.EDIToyota.ShipSchedules
			(	RawDocumentGUID
			,	ReleaseNo
			,	ShipToCode
			,	ConsigneeCode
...
execute
	@ProcReturn = EDIToyota.usp_StageShipSchedules
	@TranDT = @TranDT out
