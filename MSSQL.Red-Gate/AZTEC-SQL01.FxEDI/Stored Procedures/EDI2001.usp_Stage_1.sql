...
CREATE procedure [EDI2001].[usp_Stage_1]
...
if	exists
	(	select
		...
		where
			ed.Type = '862'
			and  left(ed.EDIStandard,6) = '002001' 
...
/*			- prepare Release Plans Supplemental.*/
	...
	select
		RawDocumentGUID
	,	ReleaseNo = coalesce(nullif(ed.Data.value('(/TRN-830/SEG-BFR/DE[@code="0328"])[1]', 'varchar(30)'),''), 
										ed.Data.value('(/TRN-830/SEG-BFR/DE[@code="0127"])[1]', 'varchar(30)'))
	, ShipToCode = coalesce(	EDIData.Releases.value('(../SEG-N1 [DE[.="ST"][@code="0098"]]/DE[@code="0067"])[1]', 'varchar(50)'),
														EDIData.Releases.value('(/*[1]/LOOP-LIN/LOOP-N1/SEG-N1 [DE[.="ST"][@code="0098"]]/DE[@code="0093"])[1]', 'varchar(50)'), 
														ed.Data.value('(/TRN-830/LOOP-N1/SEG-N1 [DE[.="ST"][@code="0098"]]/DE[@code="0067"])[1]', 'varchar(50)'), 
...
insert
	...
	,	CustomerModelYear
	,	CustomerECL
	,	UserDefined1 = Data.value('(	for $a in SEG-FST/DE[@code="0128"] where $a="DO" return $a/../DE[. >> $a][@code="0127"][1])[1]', 'varchar(30)')  --KautexDeliverOrderNumber
	,	UserDefined2 = ''
	,	UserDefined3 = ''
	,	UserDefined4 = ''
	,	UserDefined5 = ''
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI2001.StagingShipScheduleHeaders'

	insert
		FxAztec.EDI2001.StagingShipScheduleHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI2001.StagingShipScheduleSupplemental'
	
	insert 
		FxAztec.EDI2001.StagingShipScheduleSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI2001.StagingShipScheduleAccums'

	insert  FxAztec.EDI2001.StagingShipScheduleAccums
    (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI2001.StagingShipScheduleAuthAccums'

	insert
		FxAztec.EDI2001.StagingShipScheduleAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI2001.StagingShipSchedules'

	insert
		FxAztec.EDI2001.StagingShipSchedules
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI2001.StagingPlanningHeaders'

	insert
		FxAztec.EDI2001.StagingPlanningHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	insert 
		FxAztec.EDI2001.StagingPlanningSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
  ...
  ,	UserDefined1
    ...
    RawDocumentGUID
	,	ReleaseNo
	,	case when ShipToCode = 'DOCK AC' and CustomerPart = '68199 EA100' then ShiptoCode + CustomerPart when ShipToCode = 'DOCK AC' and CustomerPart = '96917 7S000'  then ShiptoCode+CustomerPart else ShipToCode end
	,	ConsigneeCode
	,	ShipFromCode
	,	SupplierCode
	,	CustomerPart	
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI2001.StagingPlanningAccums'

	insert
		FxAztec.EDI2001.StagingPlanningAccums
	 (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI2001.StagingPlanningAuthAccums'

	insert
		FxAztec.EDI2001.StagingPlanningAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'FxAztec.EDI2001.StagingPlanningReleases'

	insert
		FxAztec.EDI2001.StagingPlanningReleases
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
set	@Result = 100
	raiserror ('Chrysler documents already in process.  Use EDI2001.usp_ClearQueue to clear the queue if necessary.', 16, 1)
	return
...
execute
	@ProcReturn = EDI2001.usp_Stage_1
	@TranDT = @TranDT out
...
select
	*
from
	FxAztec.EDI2001.StagingShipScheduleHeaders sfh

Select 'StagingSSchedules'
select
	*
from
	FxAztec.EDI2001.StagingShipSchedules sfr

Select 'StagingSSAccums'
select 
	*
from
	FxAztec.EDI2001.StagingShipScheduleAccums sfs

Select 'StagingSSSupplemental'
select 
	*
from
	FxAztec.EDI2001.StagingShipScheduleSupplemental sfs
go
...
select
	*
from
	FxAztec.EDI2001.StagingPlanningHeaders sfh

Select 'PlanningReleases'
select
	*
from
	FxAztec.EDI2001.StagingPlanningReleases sfr

Select 'PlanningAccums'	
select 
	*
from
	FxAztec.EDI2001.StagingPlanningAccums sfa
Select 'PlanningAuthAccums'	

select 
	*
from
	FxAztec.EDI2001.StagingPlanningAuthAccums sfa

Select 'PlanningSupplemental'	
select 
	*
from
	FxAztec.EDI2001.StagingPlanningSupplemental sfa
