...
CREATE procedure [EDI2040].[usp_Stage_2]
...
set	@ProcName = user_name(objectproperty(@@procid, 'OwnerId')) + '.' + object_name(@@procid)  -- e.g. EDI2040.usp_Test
--- </Error Handling>
...
execute
	...
	@objname = N'EDI2040.StagingShipScheduleHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2040.StagingShipScheduleSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2040.StagingShipScheduleAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2040.StagingShipScheduleAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2040.StagingShipSchedules'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2040.StagingPlanningHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2040.StagingPlanningSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2040.StagingPlanningAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2040.StagingPlanningAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2040.StagingPlanningReleases'
...
--- <Insert rows="*">
set	@TableName = 'EDI2040.ShipScheduleHeaders'

insert
	EDI2040.ShipScheduleHeaders
(	RawDocumentGUID
,	DocumentImportDT
,	TradingPartner
,	DocType
...
,	sfh.DocumentDT
from
	EDI2040.StagingShipScheduleHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDI2040.ShipScheduleSupplemental'

insert
	EDI2040.ShipScheduleSupplemental
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI2040.StagingshipScheduleSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDI2040.ShipScheduleAccums'

insert
	EDI2040.ShipScheduleAccums
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI2040.StagingshipScheduleAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI2040.ShipScheduleAuthAccums'

insert
	EDI2040.ShipScheduleAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI2040.StagingShipScheduleAuthAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI2040.ShipSchedules'

insert
	EDI2040.ShipSchedules
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[ReleaseDT]
from
	EDI2040.StagingShipSchedulesT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI2040.PlanningHeaders'

insert
	EDI2040.PlanningHeaders
(	RawDocumentGUID
,	DocumentImportDT
,	TradingPartner
,	DocType
...
,	sfh.DocumentDT
from
	EDI2040.StagingPlanningHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDI2040.PlanningSupplemental'

insert
	EDI2040.PlanningSupplemental
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI2040.StagingPlanningSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDI2040.PlanningAccums'

insert
	EDI2040.PlanningAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI2040.StagingPlanningAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI2040.PlanningAuthAccums'

insert
	EDI2040.PlanningAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI2040.StagingPlanningAuthAccumsT 
...
--- <Insert rows="*">
set	@TableName = 'EDI2040.PlanningReleases'

insert
	EDI2040.PlanningReleases
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[DateDT]
from
	EDI2040.StagingPlanningReleasesT sfr
...
truncate table
	EDI2040.StagingShipScheduleHeadersT
truncate table
	EDI2040.StagingShipScheduleSupplementalT
truncate table
	EDI2040.StagingShipScheduleAccumsT
truncate table
	EDI2040.StagingShipScheduleAuthAccumsT
truncate table
	EDI2040.StagingShipSchedulesT
truncate table
	EDI2040.StagingPlanningHeadersT
truncate table
	EDI2040.StagingPlanningSupplementalT
truncate table
	EDI2040.StagingPlanningAccumsT
truncate table
	EDI2040.StagingPlanningAuthAccumsT
truncate table
	EDI2040.StagingPlanningReleasesT
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2040.StagingShipScheduleHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2040.StagingShipScheduleSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2040.StagingShipScheduleAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2040.StagingShipScheduleAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2040.StagingShipSchedulesT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2040.StagingPlanningHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2040.StagingPlanningSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2040.StagingPlanningAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2040.StagingPlanningAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2040.StagingPlanningReleasesT'
...
execute
	@ProcReturn = EDI2040.usp_Stage_2
	@TranDT = @TranDT out
...
select
	*
from
	EDI2040.ShipScheduleHeaders sdhv
...
select
	*
from
	EDI2040.ShipScheduleSupplemental sdrv

Select 'SSAccums'	
select
	*
from
	EDI2040.ShipScheduleAccums sdrv

Select 'SSAuthAccums'
select
	*
from
	EDI2040.ShipScheduleAuthAccums sdrv

Select 'SSchedules'
select
	*
from
	EDI2040.ShipSchedules sdrv
...
select
	*
from
	EDI2040.PlanningHeaders sdhv
Select 'PlanningSupplemental'
select
	*
from
	EDI2040.PlanningSupplemental sdrv
Select 'PlanningAccums'
select
	*
from
	EDI2040.PlanningAccums sdrv

Select 'PlanningAuthAccums'
select
	*
from
	EDI2040.PlanningAuthAccums sdrv

Select 'PlanningReleases'
select
	*
from
	EDI2040.PlanningReleases sdrv
go
