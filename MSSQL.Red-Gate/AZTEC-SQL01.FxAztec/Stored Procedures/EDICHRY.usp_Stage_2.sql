...
execute
	...
	@objname = N'EDICHRY.StagingShipScheduleHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDICHRY.StagingShipScheduleSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDICHRY.StagingShipScheduleAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDICHRY.StagingShipScheduleAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDICHRY.StagingShipSchedules'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDICHRY.StagingPlanningHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDICHRY.StagingPlanningSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDICHRY.StagingPlanningAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDICHRY.StagingPlanningAuthAccums'
...
,	sfh.DocumentDT
from
	EDICHRY.StagingShipScheduleHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDICHRY.ShipScheduleSupplemental'

insert
	EDICHRY.ShipScheduleSupplemental
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDICHRY.StagingshipScheduleSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDICHRY.ShipScheduleAccums'

insert
	EDICHRY.ShipScheduleAccums
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDICHRY.StagingshipScheduleAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDICHRY.ShipScheduleAuthAccums'

insert
	EDICHRY.ShipScheduleAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDICHRY.StagingShipScheduleAuthAccumsT sfr
...
select
      ...
      ,[ReleaseDT]
from
	EDICHRY.StagingShipSchedulesT sfr
...
,	sfh.DocumentDT
from
	EDICHRY.StagingPlanningHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDICHRY.PlanningSupplemental'

insert
	EDICHRY.PlanningSupplemental
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDICHRY.StagingPlanningSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDICHRY.PlanningAccums'

insert
	EDICHRY.PlanningAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDICHRY.StagingPlanningAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDICHRY.PlanningAuthAccums'

insert
	EDICHRY.PlanningAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[DateDT]
from
	EDICHRY.StagingPlanningReleasesT sfr
...
truncate table
	EDICHRY.StagingShipScheduleSupplementalT
truncate table
	EDICHRY.StagingShipScheduleAccumsT
truncate table
	EDICHRY.StagingShipScheduleAuthAccumsT
truncate table
	EDICHRY.StagingShipSchedulesT
truncate table
	EDICHRY.StagingPlanningHeadersT
truncate table
	EDICHRY.StagingPlanningSupplementalT
truncate table
	EDICHRY.StagingPlanningAccumsT
truncate table
	EDICHRY.StagingPlanningAuthAccumsT
truncate table
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDICHRY.StagingShipScheduleHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDICHRY.StagingShipScheduleSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDICHRY.StagingShipScheduleAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDICHRY.StagingShipScheduleAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDICHRY.StagingShipSchedulesT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDICHRY.StagingPlanningHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDICHRY.StagingPlanningSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDICHRY.StagingPlanningAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDICHRY.StagingPlanningAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDICHRY.StagingPlanningReleasesT'
...
execute
	@ProcReturn = EDICHRY.usp_Stage_2
	@TranDT = @TranDT out
...
select
	*
from
	EDICHRY.ShipScheduleHeaders sdhv
...
select
	*
from
	EDICHRY.ShipScheduleSupplemental sdrv

Select 'SSAccums'	
select
	*
from
	EDICHRY.ShipScheduleAccums sdrv

Select 'SSAuthAccums'
select
	*
from
	EDICHRY.ShipScheduleAuthAccums sdrv

Select 'SSchedules'
select
	*
from
	EDICHRY.ShipSchedules sdrv
...
select
	*
from
	EDICHRY.PlanningHeaders sdhv
Select 'PlanningSupplemental'
select
	*
from
	EDICHRY.PlanningSupplemental sdrv
Select 'PlanningAccums'
select
	*
from
	EDICHRY.PlanningAccums sdrv

Select 'PlanningAuthAccums'
select
	*
from
	EDICHRY.PlanningAuthAccums sdrv

Select 'PlanningReleases'
select
	*
from
	EDICHRY.PlanningReleases sdrv
go
