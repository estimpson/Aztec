...
create procedure [dbo].[usp_LiteTekLabel] @serial int
as
Begin
Select
	serial,
	...
	coalesce((Select max(date_stamp) from audit_trail where serial = @serial and type in ('J', 'R', 'A') ), getdate()) as MfgDate
From
	object
left join
