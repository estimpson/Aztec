...
CREATE procedure [EDISUMMIT].[usp_Stage_2]
...
execute
	...
	@objname = N'EDISUMMIT.StagingShipScheduleHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDISUMMIT.StagingShipScheduleSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDISUMMIT.StagingShipScheduleAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDISUMMIT.StagingShipScheduleAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDISUMMIT.StagingShipSchedules'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDISUMMIT.StagingPlanningHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDISUMMIT.StagingPlanningSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDISUMMIT.StagingPlanningAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDISUMMIT.StagingPlanningAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDISUMMIT.StagingPlanningReleases'
...
,	sfh.DocumentDT
from
	EDISUMMIT.StagingShipScheduleHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDISUMMIT.ShipScheduleSupplemental'

insert
	EDISUMMIT.ShipScheduleSupplemental
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDISUMMIT.StagingshipScheduleSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDISUMMIT.ShipScheduleAccums'

insert
	EDISUMMIT.ShipScheduleAccums
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDISUMMIT.StagingshipScheduleAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDISUMMIT.ShipScheduleAuthAccums'

insert
	EDISUMMIT.ShipScheduleAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDISUMMIT.StagingShipScheduleAuthAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDISUMMIT.ShipSchedules'

insert
	EDISUMMIT.ShipSchedules
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[ReleaseDT]
from
	EDISUMMIT.StagingShipSchedulesT sfr
...
,	sfh.DocumentDT
from
	EDISUMMIT.StagingPlanningHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDISUMMIT.PlanningSupplemental'

insert
	EDISUMMIT.PlanningSupplemental
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDISUMMIT.StagingPlanningSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDISUMMIT.PlanningAccums'

insert
	EDISUMMIT.PlanningAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDISUMMIT.StagingPlanningAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDISUMMIT.PlanningAuthAccums'

insert
	EDISUMMIT.PlanningAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDISUMMIT.StagingPlanningAuthAccumsT 
...
select
      ...
      ,[DateDT]
from
	EDISUMMIT.StagingPlanningReleasesT sfr
...
truncate table
	EDISUMMIT.StagingShipScheduleHeadersT
truncate table
	EDISUMMIT.StagingShipScheduleSupplementalT
truncate table
	EDISUMMIT.StagingShipScheduleAccumsT
truncate table
	EDISUMMIT.StagingShipScheduleAuthAccumsT
truncate table
	EDISUMMIT.StagingShipSchedulesT
truncate table
	EDISUMMIT.StagingPlanningHeadersT
truncate table
	EDISUMMIT.StagingPlanningSupplementalT
truncate table
	EDISUMMIT.StagingPlanningAccumsT
truncate table
	EDISUMMIT.StagingPlanningAuthAccumsT
truncate table
	EDISUMMIT.StagingPlanningReleasesT
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDISUMMIT.StagingShipScheduleHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDISUMMIT.StagingShipScheduleSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDISUMMIT.StagingShipScheduleAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDISUMMIT.StagingShipScheduleAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDISUMMIT.StagingShipSchedulesT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDISUMMIT.StagingPlanningHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDISUMMIT.StagingPlanningSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDISUMMIT.StagingPlanningAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDISUMMIT.StagingPlanningAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDISUMMIT.StagingPlanningReleasesT'
...
execute
	@ProcReturn = EDISUMMIT.usp_Stage_2
	@TranDT = @TranDT out
...
select
	*
from
	EDISUMMIT.ShipScheduleHeaders sdhv
...
select
	*
from
	EDISUMMIT.ShipScheduleSupplemental sdrv

Select 'SSAccums'	
select
	*
from
	EDISUMMIT.ShipScheduleAccums sdrv

Select 'SSAuthAccums'
select
	*
from
	EDISUMMIT.ShipScheduleAuthAccums sdrv

Select 'SSchedules'
select
	*
from
	EDISUMMIT.ShipSchedules sdrv
...
select
	*
from
	EDISUMMIT.PlanningHeaders sdhv
Select 'PlanningSupplemental'
select
	*
from
	EDISUMMIT.PlanningSupplemental sdrv
Select 'PlanningAccums'
select
	*
from
	EDISUMMIT.PlanningAccums sdrv

Select 'PlanningAuthAccums'
select
	*
from
	EDISUMMIT.PlanningAuthAccums sdrv

Select 'PlanningReleases'
select
	*
from
	EDISUMMIT.PlanningReleases sdrv
go
