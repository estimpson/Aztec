...
CREATE procedure [EDI3030].[usp_Stage_2]
...
set	@ProcName = user_name(objectproperty(@@procid, 'OwnerId')) + '.' + object_name(@@procid)  -- e.g. EDI3030.usp_Test
--- </Error Handling>
...
execute
	...
	@objname = N'EDI3030.StagingShipScheduleHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3030.StagingShipScheduleSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3030.StagingShipScheduleAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3030.StagingShipScheduleAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3030.StagingShipSchedules'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3030.StagingPlanningHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3030.StagingPlanningSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3030.StagingPlanningAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3030.StagingPlanningAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3030.StagingPlanningReleases'
...
--- <Insert rows="*">
set	@TableName = 'EDI3030.ShipScheduleHeaders'

insert
	EDI3030.ShipScheduleHeaders
(	RawDocumentGUID
,	DocumentImportDT
,	TradingPartner
,	DocType
...
,	sfh.DocumentDT
from
	EDI3030.StagingShipScheduleHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDI3030.ShipScheduleSupplemental'

insert
	EDI3030.ShipScheduleSupplemental
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI3030.StagingshipScheduleSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDI3030.ShipScheduleAccums'

insert
	EDI3030.ShipScheduleAccums
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI3030.StagingshipScheduleAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI3030.ShipScheduleAuthAccums'

insert
	EDI3030.ShipScheduleAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI3030.StagingShipScheduleAuthAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI3030.ShipSchedules'

insert
	EDI3030.ShipSchedules
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[ReleaseDT]
from
	EDI3030.StagingShipSchedulesT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI3030.PlanningHeaders'

insert
	EDI3030.PlanningHeaders
(	RawDocumentGUID
,	DocumentImportDT
,	TradingPartner
,	DocType
...
,	sfh.DocumentDT
from
	EDI3030.StagingPlanningHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDI3030.PlanningSupplemental'

insert
	EDI3030.PlanningSupplemental
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI3030.StagingPlanningSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDI3030.PlanningAccums'

insert
	EDI3030.PlanningAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI3030.StagingPlanningAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI3030.PlanningAuthAccums'

insert
	EDI3030.PlanningAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI3030.StagingPlanningAuthAccumsT 
...
--- <Insert rows="*">
set	@TableName = 'EDI3030.PlanningReleases'

insert
	EDI3030.PlanningReleases
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[DateDT]
from
	EDI3030.StagingPlanningReleasesT sfr
...
truncate table
	EDI3030.StagingShipScheduleHeadersT
truncate table
	EDI3030.StagingShipScheduleSupplementalT
truncate table
	EDI3030.StagingShipScheduleAccumsT
truncate table
	EDI3030.StagingShipScheduleAuthAccumsT
truncate table
	EDI3030.StagingShipSchedulesT
truncate table
	EDI3030.StagingPlanningHeadersT
truncate table
	EDI3030.StagingPlanningSupplementalT
truncate table
	EDI3030.StagingPlanningAccumsT
truncate table
	EDI3030.StagingPlanningAuthAccumsT
truncate table
	EDI3030.StagingPlanningReleasesT
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3030.StagingShipScheduleHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3030.StagingShipScheduleSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3030.StagingShipScheduleAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3030.StagingShipScheduleAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3030.StagingShipSchedulesT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3030.StagingPlanningHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3030.StagingPlanningSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3030.StagingPlanningAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3030.StagingPlanningAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3030.StagingPlanningReleasesT'
...
execute
	@ProcReturn = EDI3030.usp_Stage_2
	@TranDT = @TranDT out
...
select
	*
from
	EDI3030.ShipScheduleHeaders sdhv
...
select
	*
from
	EDI3030.ShipScheduleSupplemental sdrv

Select 'SSAccums'	
select
	*
from
	EDI3030.ShipScheduleAccums sdrv

Select 'SSAuthAccums'
select
	*
from
	EDI3030.ShipScheduleAuthAccums sdrv

Select 'SSchedules'
select
	*
from
	EDI3030.ShipSchedules sdrv
...
select
	*
from
	EDI3030.PlanningHeaders sdhv
Select 'PlanningSupplemental'
select
	*
from
	EDI3030.PlanningSupplemental sdrv
Select 'PlanningAccums'
select
	*
from
	EDI3030.PlanningAccums sdrv

Select 'PlanningAuthAccums'
select
	*
from
	EDI3030.PlanningAuthAccums sdrv

Select 'PlanningReleases'
select
	*
from
	EDI3030.PlanningReleases sdrv
go
