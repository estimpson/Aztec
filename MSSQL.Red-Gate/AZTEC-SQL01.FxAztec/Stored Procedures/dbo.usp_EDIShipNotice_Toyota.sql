...
CREATE procedure [dbo].[usp_EDIShipNotice_Toyota]  (@shipper int)
as
begin
-- Test
-- Exec [dbo].[usp_EDIShipNotice_Toyota] 68833
...
--Header
		...
		@1TD102_PackCountUsingRacks char(8),					--Sum of Racks in Manifest Details (used in cases where customer serializes in Fx where serials on shipper does not reflect physical count of totes on shipper
...
Declare
	...
	where
		...
		--Get Count of racks for Manifest Details

		select
		 @1TD102_PackCountUsingRacks = sum(md.Racks)
		from
			shipper s
		join
		...
		If @N104_ShipToID =  'TMMWV'
		Begin
			Set @1TD102_PackCountCNT90 = coalesce(nullif(@1TD102_PackCountUsingRacks,0),@1TD102_PackCountCNT90)
		End
...
/*
    ...
    FlatFile Layout for Overlay: TYT_810_D_v4010_TOYOTA_120702     09-27-13 17:35
    ...
    Record '01'                                             01   001   002           
       ...
       INVOICE DATE                                         DT   003   008    1BIG01 

       INVOICE #                                            AN   011   005    1BIG02 

       ('                                               ... AN   016   065           

       Record Length:                                                  080           

    Loop Start (200000 x - End Record '04')                                          

       Record '02'                                          02   001   002           

          CARD #                                            AN   003   004    1IT101 

          QTY INVOICED (EA)                                 R    007   012    1IT102 

          UNIT PRICE                                        R    019   016    1IT104 

          BASIS OF UNIT PRICE                               AN   035   002    1IT105 

          PRODUCT/SERVICE ID TYPE                           AN   037   002    1IT106 

          PRODUCT/SERVICE ID                                AN   039   012    1IT107 

          PRODUCT/SERVICE ID TYPE                           AN   051   002    1IT108 

          PRODUCT/SERVICE ID                                AN   053   012    1IT109 

          PRODUCT/SERVICE ID TYPE                           AN   065   002    1IT110 

          PRODUCT/SERVICE ID                                AN   067   012    1IT111 
    ...
    Description                                            Type Start Length Element 
       ...
       Record '04'                                          04   001   002           
          ...
          TMM RECEIVE DATE (PICK-UP DATE)                   DT   003   008    1DTM02 
    ...
    Record '05'                                             05   001   002           
       ...
       TOTAL INVOICE AMT                                    N    003   012    1TDS01 
