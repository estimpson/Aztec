...
execute
	@ProcReturn = EDI5050.usp_Stage_2
	@TranDT = @TranDT out
...
select
	*
from
	EDI5050.ShipScheduleHeaders sdhv
...
select
	*
from
	EDI5050.ShipScheduleSupplemental sdrv

Select 'SSAccums'	
select
	*
from
	EDI5050.ShipScheduleAccums sdrv

Select 'SSAuthAccums'
select
	*
from
	EDI5050.ShipScheduleAuthAccums sdrv

Select 'SSchedules'
select
	*
from
	EDI5050.ShipSchedules sdrv
...
select
	*
from
	EDI5050.PlanningHeaders sdhv
Select 'PlanningSupplemental'
select
	*
from
	EDI5050.PlanningSupplemental sdrv
Select 'PlanningAccums'
select
	*
from
	EDI5050.PlanningAccums sdrv

Select 'PlanningAuthAccums'
select
	*
from
	EDI5050.PlanningAuthAccums sdrv

Select 'PlanningReleases'
select
	*
from
	EDI5050.PlanningReleases sdrv
go
