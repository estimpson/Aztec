...
CREATE procedure [EDIToyota].[usp_Stage_2_820]
...
execute
	...
	@objname = N'EDIToyota.StagingRemittanceHeaders'
,	@newName = N'StagingRemittanceHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIToyota.StagingRemittanceDetails'
,	@newName = N'StagingRemittanceDetailsT'
...
--- <Insert rows="*">
set	@TableName = 'EDIToyota.RemittanceHeaders'

insert
	EDIToyota.RemittanceHeaders
(	RawDocumentGUID
,	DocumentImportDT
,	TradingPartner
,	DocType
...
, RemittanceTotal
 ...
 ,PaymentMethod
  ...
  ,FunctionCode
from
	EDIToyota.StagingRemittanceHeadersT 
...
/*				- StagingRemittanceDetailsT to RemittanceDetails.*/
--- <Insert rows="*">
set	@TableName = 'EDIToyota.RemittanceDetails'

insert
	EDIToyota.RemittanceDetails
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIToyota.StagingRemittanceDetailsT 
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIToyota.StagingRemittanceHeadersT'
,	@newName = N'StagingRemittanceHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIToyota.StagingRemittanceDetailsT'
,	@newName = N'StagingRemittanceDetails'
...
execute
	@ProcReturn = EDIToyota.usp_Stage_2_820
	@TranDT = @TranDT out
...
Select 'RemittanceHeaders'
select
	*
from
	EDIToyota.RemittanceHeaders sdhv
...
select
	*
from
	EDIToyota.RemittanceDetails sdrv
