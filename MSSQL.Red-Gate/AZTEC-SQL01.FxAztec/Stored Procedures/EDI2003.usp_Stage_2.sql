...
CREATE procedure [EDI2003].[usp_Stage_2]
...
execute
	...
	@objname = N'EDI2003.StagingShipScheduleHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2003.StagingShipScheduleSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2003.StagingShipScheduleAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2003.StagingShipScheduleAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2003.StagingShipSchedules'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2003.StagingPlanningHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2003.StagingPlanningSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2003.StagingPlanningAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2003.StagingPlanningAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2003.StagingPlanningReleases'
...
,	sfh.DocumentDT
from
	EDI2003.StagingShipScheduleHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDI2003.ShipScheduleSupplemental'

insert
	EDI2003.ShipScheduleSupplemental
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI2003.StagingshipScheduleSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDI2003.ShipScheduleAccums'

insert
	EDI2003.ShipScheduleAccums
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI2003.StagingshipScheduleAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI2003.ShipScheduleAuthAccums'

insert
	EDI2003.ShipScheduleAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI2003.StagingShipScheduleAuthAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI2003.ShipSchedules'

insert
	EDI2003.ShipSchedules
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[ReleaseDT]
from
	EDI2003.StagingShipSchedulesT sfr
...
,	sfh.DocumentDT
from
	EDI2003.StagingPlanningHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDI2003.PlanningSupplemental'

insert
	EDI2003.PlanningSupplemental
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI2003.StagingPlanningSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDI2003.PlanningAccums'

insert
	EDI2003.PlanningAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI2003.StagingPlanningAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI2003.PlanningAuthAccums'

insert
	EDI2003.PlanningAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI2003.StagingPlanningAuthAccumsT 
...
select
      ...
      ,[DateDT]
from
	EDI2003.StagingPlanningReleasesT sfr
...
truncate table
	EDI2003.StagingShipScheduleHeadersT
truncate table
	EDI2003.StagingShipScheduleSupplementalT
truncate table
	EDI2003.StagingShipScheduleAccumsT
truncate table
	EDI2003.StagingShipScheduleAuthAccumsT
truncate table
	EDI2003.StagingShipSchedulesT
truncate table
	EDI2003.StagingPlanningHeadersT
truncate table
	EDI2003.StagingPlanningSupplementalT
truncate table
	EDI2003.StagingPlanningAccumsT
truncate table
	EDI2003.StagingPlanningAuthAccumsT
truncate table
	EDI2003.StagingPlanningReleasesT
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2003.StagingShipScheduleHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2003.StagingShipScheduleSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2003.StagingShipScheduleAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2003.StagingShipScheduleAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2003.StagingShipSchedulesT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2003.StagingPlanningHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2003.StagingPlanningSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2003.StagingPlanningAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2003.StagingPlanningAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI2003.StagingPlanningReleasesT'
...
execute
	@ProcReturn = EDI2003.usp_Stage_2
	@TranDT = @TranDT out
...
select
	*
from
	EDI2003.ShipScheduleHeaders sdhv
...
select
	*
from
	EDI2003.ShipScheduleSupplemental sdrv

Select 'SSAccums'	
select
	*
from
	EDI2003.ShipScheduleAccums sdrv

Select 'SSAuthAccums'
select
	*
from
	EDI2003.ShipScheduleAuthAccums sdrv

Select 'SSchedules'
select
	*
from
	EDI2003.ShipSchedules sdrv
...
select
	*
from
	EDI2003.PlanningHeaders sdhv
Select 'PlanningSupplemental'
select
	*
from
	EDI2003.PlanningSupplemental sdrv
Select 'PlanningAccums'
select
	*
from
	EDI2003.PlanningAccums sdrv

Select 'PlanningAuthAccums'
select
	*
from
	EDI2003.PlanningAuthAccums sdrv

Select 'PlanningReleases'
select
	*
from
	EDI2003.PlanningReleases sdrv
go
