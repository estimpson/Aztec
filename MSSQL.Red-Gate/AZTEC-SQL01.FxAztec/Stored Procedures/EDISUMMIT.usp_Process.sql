	...
	/*if  exists
		...
		*/
		...
		join
		  ...
		  join
				EDISUMMIT.PlanningSupplemental prs
		on
		...
		join
		  ...
		  join
				EDISUMMIT.ShipScheduleSupplemental sss
		on
...
and not exists
( Select 1 from 
		EDISUMMIT.ShipSchedules b
 Join 
	EDISUMMIT.BlanketOrders bo on b.CustomerPart = bo.CustomerPart
and
...
(	bo.CheckModelYearShipSchedule = 0
	or bo.ModelYear862 = a.CustomerModelYear)
	left join
		EDISUMMIT.ShipScheduleAccums ssa on 
 	...
 	left join
		EDISUMMIT.ShipScheduleAuthAccums ssaa on 
...
(	bo.CheckModelYearPlanning = 0
	or bo.ModelYear830 = a.CustomerModelYear)
	left join
		EDISUMMIT.PlanningAccums pra on 
 	...
 	left join
		EDISUMMIT.PlanningAuthAccums praa on 
...
Begin
		...
		,	@EmailHeader NVARCHAR(MAX) = 'EDI Processing for EDISUMMIT' 
