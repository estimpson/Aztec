...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[ftsp_FordAF52M_Demand]
as
begin
...
where	(order_header.destination  like 'AF%' or order_header.destination  like '%R3MSA%' or order_header.destination like '%F201C%')  and order_detail.due_date >= dateadd(dd, -60, getdate())
order by 4 ,7
SET TRANSACTION ISOLATION LEVEL
read committed 
end
