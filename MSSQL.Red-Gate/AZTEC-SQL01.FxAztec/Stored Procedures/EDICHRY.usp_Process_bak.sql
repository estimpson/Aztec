...
CREATE procedure [EDICHRY].[usp_Process_bak]
...
from
  ...
  join
		@Current862s css 
		on fr.RawDocumentGUID = css.RawDocumentGUID
		and fr.CustomerPart = css.CustomerPart
...
Begin
		...
		,	@EmailHeader NVARCHAR(MAX) = 'EDI Processing for EDICHRY' 
