...
CREATE procedure [EDI3010].[usp_Stage_2]
...
set	@ProcName = user_name(objectproperty(@@procid, 'OwnerId')) + '.' + object_name(@@procid)  -- e.g. EDI3010.usp_Test
--- </Error Handling>
...
execute
	...
	@objname = N'EDI3010.StagingShipScheduleHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3010.StagingShipScheduleSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3010.StagingShipScheduleAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3010.StagingShipScheduleAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3010.StagingShipSchedules'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3010.StagingPlanningHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3010.StagingPlanningSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3010.StagingPlanningAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3010.StagingPlanningAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3010.StagingPlanningReleases'
...
--- <Insert rows="*">
set	@TableName = 'EDI3010.ShipScheduleHeaders'

insert
	EDI3010.ShipScheduleHeaders
(	RawDocumentGUID
,	DocumentImportDT
,	TradingPartner
,	DocType
...
,	sfh.DocumentDT
from
	EDI3010.StagingShipScheduleHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDI3010.ShipScheduleSupplemental'

insert
	EDI3010.ShipScheduleSupplemental
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI3010.StagingshipScheduleSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDI3010.ShipScheduleAccums'

insert
	EDI3010.ShipScheduleAccums
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI3010.StagingshipScheduleAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI3010.ShipScheduleAuthAccums'

insert
	EDI3010.ShipScheduleAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI3010.StagingShipScheduleAuthAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI3010.ShipSchedules'

insert
	EDI3010.ShipSchedules
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[ReleaseDT]
from
	EDI3010.StagingShipSchedulesT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI3010.PlanningHeaders'

insert
	EDI3010.PlanningHeaders
(	RawDocumentGUID
,	DocumentImportDT
,	TradingPartner
,	DocType
...
,	sfh.DocumentDT
from
	EDI3010.StagingPlanningHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDI3010.PlanningSupplemental'

insert
	EDI3010.PlanningSupplemental
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI3010.StagingPlanningSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDI3010.PlanningAccums'

insert
	EDI3010.PlanningAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI3010.StagingPlanningAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI3010.PlanningAuthAccums'

insert
	EDI3010.PlanningAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI3010.StagingPlanningAuthAccumsT 
...
--- <Insert rows="*">
set	@TableName = 'EDI3010.PlanningReleases'

insert
	EDI3010.PlanningReleases
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[DateDT]
from
	EDI3010.StagingPlanningReleasesT sfr
...
truncate table
	EDI3010.StagingShipScheduleHeadersT
truncate table
	EDI3010.StagingShipScheduleSupplementalT
truncate table
	EDI3010.StagingShipScheduleAccumsT
truncate table
	EDI3010.StagingShipScheduleAuthAccumsT
truncate table
	EDI3010.StagingShipSchedulesT
truncate table
	EDI3010.StagingPlanningHeadersT
truncate table
	EDI3010.StagingPlanningSupplementalT
truncate table
	EDI3010.StagingPlanningAccumsT
truncate table
	EDI3010.StagingPlanningAuthAccumsT
truncate table
	EDI3010.StagingPlanningReleasesT
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3010.StagingShipScheduleHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3010.StagingShipScheduleSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3010.StagingShipScheduleAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3010.StagingShipScheduleAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3010.StagingShipSchedulesT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3010.StagingPlanningHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3010.StagingPlanningSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3010.StagingPlanningAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3010.StagingPlanningAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3010.StagingPlanningReleasesT'
...
execute
	@ProcReturn = EDI3010.usp_Stage_2
	@TranDT = @TranDT out
...
select
	*
from
	EDI3010.ShipScheduleHeaders sdhv
...
select
	*
from
	EDI3010.ShipScheduleSupplemental sdrv

Select 'SSAccums'	
select
	*
from
	EDI3010.ShipScheduleAccums sdrv

Select 'SSAuthAccums'
select
	*
from
	EDI3010.ShipScheduleAuthAccums sdrv

Select 'SSchedules'
select
	*
from
	EDI3010.ShipSchedules sdrv
...
select
	*
from
	EDI3010.PlanningHeaders sdhv
Select 'PlanningSupplemental'
select
	*
from
	EDI3010.PlanningSupplemental sdrv
Select 'PlanningAccums'
select
	*
from
	EDI3010.PlanningAccums sdrv

Select 'PlanningAuthAccums'
select
	*
from
	EDI3010.PlanningAuthAccums sdrv

Select 'PlanningReleases'
select
	*
from
	EDI3010.PlanningReleases sdrv
go
