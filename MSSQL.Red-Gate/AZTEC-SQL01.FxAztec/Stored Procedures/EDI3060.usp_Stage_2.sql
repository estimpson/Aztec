...
CREATE procedure [EDI3060].[usp_Stage_2]
...
execute
	...
	@objname = N'EDI3060.StagingShipScheduleHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3060.StagingShipScheduleSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3060.StagingShipScheduleAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3060.StagingShipScheduleAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3060.StagingShipSchedules'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3060.StagingPlanningHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3060.StagingPlanningSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3060.StagingPlanningAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3060.StagingPlanningAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3060.StagingPlanningReleases'
...
,	sfh.DocumentDT
from
	EDI3060.StagingShipScheduleHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDI3060.ShipScheduleSupplemental'
...
from
	EDI3060.StagingshipScheduleSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDI3060.ShipScheduleAccums'
...
from
	EDI3060.StagingshipScheduleAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI3060.ShipScheduleAuthAccums'
...
from
	EDI3060.StagingShipScheduleAuthAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI3060.ShipSchedules'

insert
	EDI3060.ShipSchedules
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[ReleaseDT]
from
	EDI3060.StagingShipSchedulesT sfr
...
,	sfh.DocumentDT
from
	EDI3060.StagingPlanningHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDI3060.PlanningSupplemental'

insert
	EDI3060.PlanningSupplemental
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI3060.StagingPlanningSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDI3060.PlanningAccums'

insert
	EDI3060.PlanningAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI3060.StagingPlanningAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI3060.PlanningAuthAccums'

insert
	EDI3060.PlanningAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI3060.StagingPlanningAuthAccumsT 
...
select
      ...
      ,[DateDT]
from
	EDI3060.StagingPlanningReleasesT sfr
...
truncate table
	EDI3060.StagingShipScheduleHeadersT
truncate table
	EDI3060.StagingShipScheduleSupplementalT
truncate table
	EDI3060.StagingShipScheduleAccumsT
truncate table
	EDI3060.StagingShipScheduleAuthAccumsT
truncate table
	EDI3060.StagingShipSchedulesT
truncate table
	EDI3060.StagingPlanningHeadersT
truncate table
	EDI3060.StagingPlanningSupplementalT
truncate table
	EDI3060.StagingPlanningAccumsT
truncate table
	EDI3060.StagingPlanningAuthAccumsT
truncate table
	EDI3060.StagingPlanningReleasesT
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3060.StagingShipScheduleHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3060.StagingShipScheduleSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3060.StagingShipScheduleAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3060.StagingShipScheduleAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3060.StagingShipSchedulesT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3060.StagingPlanningHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3060.StagingPlanningSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3060.StagingPlanningAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3060.StagingPlanningAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3060.StagingPlanningReleasesT'
...
execute
	@ProcReturn = EDI3060.usp_Stage_2
	@TranDT = @TranDT out
...
select
	*
from
	EDI3060.ShipScheduleHeaders sdhv
...
select
	*
from
	EDI3060.ShipScheduleSupplemental sdrv

Select 'SSAccums'	
select
	*
from
	EDI3060.ShipScheduleAccums sdrv

Select 'SSAuthAccums'
select
	*
from
	EDI3060.ShipScheduleAuthAccums sdrv

Select 'SSchedules'
select
	*
from
	EDI3060.ShipSchedules sdrv
...
select
	*
from
	EDI3060.PlanningHeaders sdhv
Select 'PlanningSupplemental'
select
	*
from
	EDI3060.PlanningSupplemental sdrv
Select 'PlanningAccums'
select
	*
from
	EDI3060.PlanningAccums sdrv

Select 'PlanningAuthAccums'
select
	*
from
	EDI3060.PlanningAuthAccums sdrv

Select 'PlanningReleases'
select
	*
from
	EDI3060.PlanningReleases sdrv
go
