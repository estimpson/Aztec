...
create function [fordEDI].[Current830s]
()
...
--- <Body>
	...
	declare
		@Ford830LastDocumentImportDTs table
	(	ShipToCode varchar (15)
	,	ShipFromCode varchar (15)
	,	ICCode varchar(15)
	,	CustomerPart varchar(35)
	...
	from
		...
		join @Ford830LastDocumentDTs flddt
		...
		join @Ford830LastDocNumbers fldn
		...
		join @Ford830LastDocumentImportDTs fldidt
