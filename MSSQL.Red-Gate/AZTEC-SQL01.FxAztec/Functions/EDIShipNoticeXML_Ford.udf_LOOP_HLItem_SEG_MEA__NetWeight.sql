...
CREATE FUNCTION [EDIShipNoticeXML_Ford].[udf_LOOP_HLItem_SEG_MEA__NetWeight]
(	@ShipperID INT
	...
	/*	SEG-ATH*/
		(	SELECT
			...
			,	(	SELECT
					...
					,	[DE!1!type]='N'
					,	[DE!1]= CONVERT(INT,SUM(sd.net_weight))
					FOR XML EXPLICIT, TYPE
...
---	<Return>
	RETURN
		@outputXML
END
 --Select [EDIShipNoticeXML_Ford].[udf_LOOP_HLItem_SEG_MEA__NetWeight] (1062979)
