...
CREATE FUNCTION [EDIShipNoticeXML_Ford].[udf_LOOP_HLShipment_SEG_MEA__GrossWeight]
(	@ShipperID INT
)
RETURNS XML
AS
	...
	/*	SEG-ATH*/
		(	SELECT
			...
			,	(	SELECT
					...
					,	[DE!1!type]='N'
					,	[DE!1]= CONVERT(INT,s.gross_weight)
					FOR XML EXPLICIT, TYPE
...
---	<Return>
	RETURN
		@outputXML
END
 --Select [EDIShipNoticeXML_Ford].[udf_LOOP_HLShipment_SEG_MEA__GrossWeight] (1062979)
