CREATE TABLE [EDI2001].[ShipScheduleSupplemental]
(
[Status] [int] NOT NULL CONSTRAINT [DF__ShipSched__Statu__2EB59D29] DEFAULT ((0)),
[Type] [int] NOT NULL CONSTRAINT [DF__ShipSchedu__Type__2FA9C162] DEFAULT ((0)),
...
[RowCreateDT] [datetime] NULL CONSTRAINT [DF__ShipSched__RowCr__309DE59B] DEFAULT (getdate()),
[RowCreateUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ShipSched__RowCr__319209D4] DEFAULT (user_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__ShipSched__RowMo__32862E0D] DEFAULT (getdate()),
[RowModifiedUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ShipSched__RowMo__337A5246] DEFAULT (user_name())
) ON [PRIMARY]
GO
ALTER TABLE [EDI2001].[ShipScheduleSupplemental] ADD CONSTRAINT [PK__ShipSche__FFEE74500F167BAF] PRIMARY KEY NONCLUSTERED  ([RowID]) ON [PRIMARY]
GO
