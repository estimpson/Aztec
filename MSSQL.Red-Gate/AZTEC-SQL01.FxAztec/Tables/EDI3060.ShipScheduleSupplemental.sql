...
(
[Status] [int] NOT NULL CONSTRAINT [DF__ShipSched__Statu__264052B9] DEFAULT ((0)),
[Type] [int] NOT NULL CONSTRAINT [DF__ShipSchedu__Type__273476F2] DEFAULT ((0)),
...
[RowCreateDT] [datetime] NULL CONSTRAINT [DF__ShipSched__RowCr__28289B2B] DEFAULT (getdate()),
[RowCreateUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ShipSched__RowCr__291CBF64] DEFAULT (user_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__ShipSched__RowMo__2A10E39D] DEFAULT (getdate()),
[RowModifiedUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ShipSched__RowMo__2B0507D6] DEFAULT (user_name())
) ON [PRIMARY]
GO
ALTER TABLE [EDI3060].[ShipScheduleSupplemental] ADD CONSTRAINT [PK__ShipSche__FFEE745012CFC03F] PRIMARY KEY NONCLUSTERED  ([RowID]) ON [PRIMARY]
GO
