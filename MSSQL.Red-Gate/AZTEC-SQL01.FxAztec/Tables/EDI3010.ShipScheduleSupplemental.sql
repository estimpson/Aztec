CREATE TABLE [EDI3010].[ShipScheduleSupplemental]
(
[Status] [int] NOT NULL CONSTRAINT [DF__ShipSched__Statu__2A7AF7F1] DEFAULT ((0)),
[Type] [int] NOT NULL CONSTRAINT [DF__ShipSchedu__Type__2B6F1C2A] DEFAULT ((0)),
...
[RowCreateDT] [datetime] NULL CONSTRAINT [DF__ShipSched__RowCr__2C634063] DEFAULT (getdate()),
[RowCreateUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ShipSched__RowCr__2D57649C] DEFAULT (user_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__ShipSched__RowMo__2E4B88D5] DEFAULT (getdate()),
[RowModifiedUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ShipSched__RowMo__2F3FAD0E] DEFAULT (user_name())
) ON [PRIMARY]
GO
ALTER TABLE [EDI3010].[ShipScheduleSupplemental] ADD CONSTRAINT [PK__ShipSche__FFEE74508AF2FBFA] PRIMARY KEY NONCLUSTERED  ([RowID]) ON [PRIMARY]
GO
