...
(
[Status] [int] NOT NULL CONSTRAINT [DF__ShipSched__Statu__6AEA82C1] DEFAULT ((0)),
[Type] [int] NOT NULL CONSTRAINT [DF__ShipSchedu__Type__6BDEA6FA] DEFAULT ((0)),
...
[RowCreateDT] [datetime] NULL CONSTRAINT [DF__ShipSched__RowCr__6CD2CB33] DEFAULT (getdate()),
[RowCreateUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ShipSched__RowCr__6DC6EF6C] DEFAULT (user_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__ShipSched__RowMo__6EBB13A5] DEFAULT (getdate()),
[RowModifiedUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ShipSched__RowMo__6FAF37DE] DEFAULT (user_name())
) ON [PRIMARY]
GO
ALTER TABLE [EDI4010].[ShipScheduleSupplemental] ADD CONSTRAINT [PK__ShipSche__FFEE74503CA5C59A] PRIMARY KEY NONCLUSTERED  ([RowID]) ON [PRIMARY]
GO
