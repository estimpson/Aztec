...
create trigger [dbo].[cdc_po_detail_d] on [dbo].[po_detail] after delete
as
insert
	CDC.po_detail
(	__$operation
...
create trigger [dbo].[cdc_po_detail_i] on [dbo].[po_detail] after insert
as
insert
	CDC.po_detail
(	__$operation
...
create trigger [dbo].[cdc_po_detail_u] on [dbo].[po_detail] after update
as
insert
	CDC.po_detail
(	__$operation
