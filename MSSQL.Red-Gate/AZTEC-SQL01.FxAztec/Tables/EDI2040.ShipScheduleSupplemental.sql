...
(
[Status] [int] NOT NULL CONSTRAINT [DF__ShipSched__Statu__65D0C7E9] DEFAULT ((0)),
[Type] [int] NOT NULL CONSTRAINT [DF__ShipSchedu__Type__66C4EC22] DEFAULT ((0)),
...
[RowCreateDT] [datetime] NULL CONSTRAINT [DF__ShipSched__RowCr__67B9105B] DEFAULT (getdate()),
[RowCreateUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ShipSched__RowCr__68AD3494] DEFAULT (user_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__ShipSched__RowMo__69A158CD] DEFAULT (getdate()),
[RowModifiedUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ShipSched__RowMo__6A957D06] DEFAULT (user_name())
) ON [PRIMARY]
GO
ALTER TABLE [EDI2040].[ShipScheduleSupplemental] ADD CONSTRAINT [PK__ShipSche__FFEE7450B1EB4136] PRIMARY KEY NONCLUSTERED  ([RowID]) ON [PRIMARY]
GO
