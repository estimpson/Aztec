...
(
[Status] [int] NOT NULL CONSTRAINT [DF__ShipSched__Statu__619622B1] DEFAULT ((0)),
[Type] [int] NOT NULL CONSTRAINT [DF__ShipSchedu__Type__628A46EA] DEFAULT ((0)),
...
[RowCreateDT] [datetime] NULL CONSTRAINT [DF__ShipSched__RowCr__637E6B23] DEFAULT (getdate()),
[RowCreateUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ShipSched__RowCr__64728F5C] DEFAULT (user_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__ShipSched__RowMo__6566B395] DEFAULT (getdate()),
[RowModifiedUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ShipSched__RowMo__665AD7CE] DEFAULT (user_name())
) ON [PRIMARY]
GO
ALTER TABLE [EDI3030].[ShipScheduleSupplemental] ADD CONSTRAINT [PK__ShipSche__FFEE74508A71F634] PRIMARY KEY NONCLUSTERED  ([RowID]) ON [PRIMARY]
GO
