...
(
[Status] [int] NOT NULL CONSTRAINT [DF__ShipSched__Statu__4C30F177] DEFAULT ((0)),
[Type] [int] NOT NULL CONSTRAINT [DF__ShipSchedu__Type__4D2515B0] DEFAULT ((0)),
...
[RowCreateDT] [datetime] NULL CONSTRAINT [DF__ShipSched__RowCr__4E1939E9] DEFAULT (getdate()),
[RowCreateUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ShipSched__RowCr__4F0D5E22] DEFAULT (user_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__ShipSched__RowMo__5001825B] DEFAULT (getdate()),
[RowModifiedUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ShipSched__RowMo__50F5A694] DEFAULT (user_name())
) ON [PRIMARY]
GO
ALTER TABLE [EDI5050].[ShipScheduleSupplemental] ADD CONSTRAINT [PK__ShipSche__FFEE7450B044D6FE] PRIMARY KEY NONCLUSTERED  ([RowID]) ON [PRIMARY]
GO
