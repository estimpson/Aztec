...
(
[Status] [int] NOT NULL CONSTRAINT [DF__ShipSched__Statu__0FFC0BDF] DEFAULT ((0)),
[Type] [int] NOT NULL CONSTRAINT [DF__ShipSchedu__Type__10F03018] DEFAULT ((0)),
...
[RowCreateDT] [datetime] NULL CONSTRAINT [DF__ShipSched__RowCr__11E45451] DEFAULT (getdate()),
[RowCreateUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ShipSched__RowCr__12D8788A] DEFAULT (user_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__ShipSched__RowMo__13CC9CC3] DEFAULT (getdate()),
[RowModifiedUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ShipSched__RowMo__14C0C0FC] DEFAULT (user_name())
) ON [PRIMARY]
GO
ALTER TABLE [EDI2002].[ShipScheduleSupplemental] ADD CONSTRAINT [PK__ShipSche__FFEE7450A4F6FA89] PRIMARY KEY NONCLUSTERED  ([RowID]) ON [PRIMARY]
GO
